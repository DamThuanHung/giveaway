...
export const metadata: Metadata = {
  title: "Bài đăng — Mua bán & trao tặng đồ cũ",
  description:
    "Tất cả bài đăng đồ cũ, đồ tặng miễn phí trên Trao Tay. Tìm theo khu vực, danh mục, giá. Cập nhật mới mỗi ngày.",
