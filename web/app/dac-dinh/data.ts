...
export const MATCHINGS: MatchingQuestion[] = [
  {
    id: "mt-cs5-1",
    chapterId: "cs-ch5",
    instructionJa: "次の3つの緊急事態を、それぞれ正しい対応の原則に当てはめてください。",
    instructionVi: "Hãy ghép đúng 3 tình huống khẩn cấp sau đây với nguyên tắc xử lý tương ứng.",
    items: [
      {
        id: "taichofuryo",
        ja: "体調不良者が発生した場合",
        vi: "Khách bị khó chịu trong người",
        targetId: "t1",
        sourceQuoteJa: "お客様で体調不良者が発生した場合、決して慌てずに、同伴者がいれば同伴者の指示に従ってください。",
        sourcePage: 18,
      },
      {
        id: "tenkan",
        ja: "てんかん発作で倒れた場合",
        vi: "Khách ngã do lên cơn động kinh",
        targetId: "t2",
        sourceQuoteJa: "てんかん発作で倒れたお客様には、付き添いの方がいれば、その方の指示に従ってください。付き添いの方がいない場合は、すぐに救急車を呼んでください。",
        sourcePage: 19,
      },
    ...
    targets: [
      { id: "t1", labelJa: "慌てず、同伴者がいればその指示に従う", labelVi: "Không hoảng loạn, có người đi cùng thì làm theo chỉ dẫn người đó" },
      { id: "t2", labelJa: "付き添いがいなければ、意識の有無に関わらずすぐ救急車", labelVi: "Không có người đi cùng thì gọi cấp cứu ngay, bất kể tỉnh hay không" },
      { id: "t3", labelJa: "AEDをすぐに当て、同時に救急車を呼ぶ", labelVi: "Dùng AED ngay lập tức, đồng thời gọi xe cấp cứu" },
    ],
    explanationVi:
      "3 tình huống khẩn cấp có nguyên tắc quyết định KHÁC NHAU dễ nhầm: 'khó chịu chung' quyết định theo Ý THỨC của khách (tỉnh táo thì theo ý khách, bất tỉnh thì cấp cứu); RIÊNG 'động kinh' quyết định theo CÓ/KHÔNG người đi cùng (không phụ thuộc ý thức khách); 'ngừng tim' luôn dùng AED ngay lập tức không cần cân nhắc gì thêm.",
  },
  {
    id: "mt-cs1-1",
    chapterId: "cs-ch1",
    instructionJa: "次の4つのチェック項目を、それぞれ正しいQSCAの区分に当てはめてください。",
    instructionVi: "Hãy ghép đúng 4 mục kiểm tra sau đây với hạng mục QSCA tương ứng.",
    items: [
      {
        id: "ryouri_check",
        ja: "いつも通りの味・分量・盛り付けで提供できているか",
        vi: "Có phục vụ đúng vị/lượng/cách bày như thường lệ không",
        targetId: "quality",
        sourceQuoteJa: "〇料理の品質（Quality）ア いつも通りの味・分量・盛り付けで提供できているか確認してください。イ メニューが清潔な状態で提供されているか確認してください。ウ 注文通りに適正な温度や状態、時間で提供されているか確認してください。",
        sourcePage: 1,
      },
      {
        id: "order_check",
        ja: "オーダー（注文）受けが放置されていないか",
        vi: "Việc nhận order có bị bỏ mặc không",
        targetId: "service",
        sourceQuoteJa: "〇サービス（Service）ア 従業員が笑顔とアイコンタクト、正しい姿勢や声で応対しているか確認してください。カ フルサービスのお店でオーダー（注文）受けが放置されていないか確認してください。キ 出来上がった料理が、適正な温度や状態で、適正な時間内にお客様のテーブルに配膳されているか確認してください。",
        sourcePage: 2,
      },
      {
        id: "toilet_check",
        ja: "客用トイレに異臭がなく清潔感があるか",
        vi: "Nhà vệ sinh khách không có mùi lạ và sạch sẽ",
      ...
      {
        id: "bgm_check",
        ja: "BGMの選曲は適切であり、適度な音量で流れているか",
        vi: "Nhạc nền có phù hợp và âm lượng vừa phải không",
        targetId: "atmosphere",
        sourceQuoteJa: "〇雰囲気（Atmosphere）ア 店内空調温度が快適かどうか確認してください。エ BGM の選曲は適切であり、適度な音量で流れているか確認してください。ウ 点灯すべき電飾看板、イルミネーションが点いているか確認してください。",
        sourcePage: 2,
      },
    ...
    targets: [
      { id: "quality", labelJa: "Quality（料理の品質）", labelVi: "Quality (Chất lượng món ăn)" },
      { id: "service", labelJa: "Service（サービス）", labelVi: "Service (Dịch vụ)" },
      { id: "cleanliness", labelJa: "Cleanliness（清潔感）", labelVi: "Cleanliness (Sạch sẽ)" },
      { id: "atmosphere", labelJa: "Atmosphere（雰囲気）", labelVi: "Atmosphere (Bầu không khí)" },
    ],
    explanationVi:
      "4 mục kiểm tra tưởng chừng dễ nhầm hạng mục: 'nhận order không bị bỏ mặc' thuộc SERVICE (thao tác con người) chứ không phải QUALITY (dù liên quan đến món ăn, nhưng đây là hành vi phục vụ); 'nhà vệ sinh sạch' thuộc CLEANLINESS; 'nhạc nền phù hợp' thuộc ATMOSPHERE (không khí chung, không phải sạch sẽ vật lý).",
  },
  {
    id: "mt-ck5-1",
    chapterId: "ck-ch5",
    instructionJa: "飲食店の労働災害の事故類型を、多い順（1位〜4位）に当てはめてください。",
    instructionVi: "Hãy ghép đúng các loại tai nạn lao động tại nhà hàng vào đúng thứ hạng (1-4, từ nhiều nhất).",
    items: [
      {
        id: "tentou",
        ja: "転倒",
      ...
      },
      {
        id: "dousa_handou",
        ja: "動作の反動・無理な動作",
        vi: "Phản lực động tác/động tác gắng sức",
        targetId: "t4",
        sourceQuoteJa: "次に「切れ・こすれ」、「高温・低温物との接触」、「動作の反動・無理な動作」の順となっています。",
        sourcePage: 11,
      },
    ...
    targets: [
      { id: "t1", labelJa: "1位（全体の約3割）", labelVi: "Hạng 1 (khoảng 30% tổng số)" },
      { id: "t2", labelJa: "2位", labelVi: "Hạng 2" },
      { id: "t3", labelJa: "3位", labelVi: "Hạng 3" },
      { id: "t4", labelJa: "4位", labelVi: "Hạng 4" },
    ],
    explanationVi:
      "Thứ hạng tai nạn lao động tại nhà hàng theo đúng thứ tự: 1) 転倒 (té ngã, ~30%) 2) 切れ・こすれ (đứt/trầy xước) 3) 高温・低温物との接触 (tiếp xúc vật nóng/lạnh) 4) 動作の反動・無理な動作 (phản lực động tác) — dễ nhầm thứ tự giữa hạng 2-3-4 vì cả 3 đều xuất hiện trong cùng 1 câu liệt kê.",
  },
  {
    id: "mt-ck3-1",
    chapterId: "ck-ch3",
    instructionJa: "次の6つの加熱調理法を、それぞれ正しい方法に当てはめてください。",
    instructionVi: "Hãy ghép đúng 6 phương pháp nấu chín sau đây với cách thực hiện tương ứng.",
    items: [
      {
        id: "yuderu",
        ja: "茹でる",
    ...
    targets: [
      { id: "t1", labelJa: "多量の水又は熱湯の中で加熱", labelVi: "Nấu trong nhiều nước hoặc nước sôi" },
      { id: "t2", labelJa: "調味料の入った煮汁やだし汁で加熱", labelVi: "Nấu bằng nước dùng/nước kho có gia vị" },
      { id: "t3", labelJa: "高温・多量の油で加熱、水分減少し油を吸収", labelVi: "Nhiều dầu, nhiệt độ cao; nước giảm, hấp thụ dầu" },
      { id: "t4", labelJa: "あまり動かさず中までじっくり火を通す", labelVi: "Ít di chuyển, làm chín kỹ từ từ đến bên trong" },
      { id: "t5", labelJa: "高温・少量の油脂で撹拌しながら短時間加熱", labelVi: "Ít dầu, nhiệt độ cao, vừa khuấy vừa nấu nhanh" },
      { id: "t6", labelJa: "蒸し器やせいろで水蒸気で加熱", labelVi: "Dùng nồi hấp/xửng, nấu bằng hơi nước" },
    ],
    explanationVi:
      "6 phương pháp nấu chín dễ nhầm vì nhiều cặp tương tự nhau: 茹でる/煮る đều dùng nước nhưng khác ở CÓ/KHÔNG gia vị; 揚げる/炒める đều dùng dầu nhưng khác lượng dầu và cách thao tác (chiên ngập dầu tĩnh vs xào ít dầu khuấy liên tục); 焼く khác biệt ở chỗ ÍT DI CHUYỂN thực phẩm.",
  },
  {
    id: "mt-ck2-1",
    chapterId: "ck-ch2",
    instructionJa: "次の3種類の野菜の下処理を、それぞれ正しい結果に当てはめてください。",
    instructionVi: "Hãy ghép đúng 3 cách sơ chế rau củ sau đây với kết quả tương ứng.",
    items: [
      {
        id: "imo_nasu",
        ja: "いも類・なすを冷水につける",
        vi: "Ngâm khoai/cà tím vào nước lạnh",
        targetId: "t1",
        sourceQuoteJa: "じゃがいも、さつまいもなどのいも類やなすは冷水につけてあく抜きをします。",
        sourcePage: 5,
      },
      {
        id: "renkon_gobo",
        ja: "れんこん・ごぼうを酢水に入れる",
        vi: "Ngâm củ sen/ngưu bàng vào nước giấm",
        targetId: "t2",
        sourceQuoteJa: "れんこんやごぼうは酢水に入れると白くなります。",
        sourcePage: 5,
      },
    ...
    targets: [
      { id: "t1", labelJa: "あく抜きになる", labelVi: "Khử được vị đắng/chát" },
      { id: "t2", labelJa: "白くなる", labelVi: "Chuyển màu trắng" },
      { id: "t3", labelJa: "浸透圧で水分が出てしんなりする", labelVi: "Do thẩm thấu, nước thoát ra làm rau mềm xuống" },
    ],
    explanationVi:
      "3 cách sơ chế rau củ cho 3 kết quả khác nhau: ngâm nước lạnh KHỬ VỊ ĐẮNG, ngâm giấm làm TRẮNG (đổi màu), bóp muối làm MỀM (do thẩm thấu) — dễ nhầm vì đều là \"ngâm/xử lý với nước\" nhưng cơ chế và mục đích khác hẳn nhau.",
  },
  {
    id: "mt-ck1-1",
    chapterId: "ck-ch1",
    instructionJa: "次の3種類の肉を、それぞれ正しい鮮度の見分け方に当てはめてください。",
    instructionVi: "Hãy ghép đúng 3 loại thịt sau đây với cách nhận biết độ tươi tương ứng.",
    items: [
      {
        id: "gyuniku",
        ja: "牛肉",
    ...
    targets: [
      { id: "t1", labelJa: "鮮やかな赤色で赤身と脂身の境目がはっきり", labelVi: "Màu đỏ tươi, ranh giới nạc-mỡ rõ ràng" },
      { id: "t2", labelJa: "艶のある淡いピンク色で脂身は白い", labelVi: "Hồng nhạt bóng, phần mỡ trắng" },
      { id: "t3", labelJa: "透明感のあるピンク色で皮の毛穴に凹凸がある", labelVi: "Hồng trong, lỗ chân lông trên da có độ gồ ghề" },
    ],
    explanationVi:
      "Mỗi loại thịt có tiêu chí nhận biết độ tươi RIÊNG dựa trên đặc điểm màu sắc/kết cấu khác nhau — dễ nhầm giữa heo và gà vì cả hai đều liên quan đến \"màu hồng\", nhưng heo chú trọng độ BÓNG và MÀU MỠ TRẮNG, còn gà chú trọng ĐỘ TRONG và KẾT CẤU DA (lỗ chân lông gồ ghề).",
  },
  {
    id: "mt-hy2-1",
    chapterId: "hy-ch2",
    instructionJa: "食中毒予防の3原則を、それぞれ関連する具体策・特徴に当てはめてください。",
    instructionVi: "Hãy ghép đúng 3 nguyên tắc phòng ngừa ngộ độc thực phẩm với biện pháp cụ thể/đặc điểm liên quan tương ứng.",
    items: [
      {
        id: "tsukenai",
        ja: "つけない",
    ...
    targets: [
      { id: "t1", labelJa: "ノロウイルスなどの少量感染対策で特に重要", labelVi: "Đặc biệt quan trọng với vi sinh vật lây nhiễm liều nhỏ như Norovirus" },
      { id: "t2", labelJa: "低温10℃以下または高温60℃以上で保管", labelVi: "Bảo quản ở nhiệt độ thấp (dưới 10°C) hoặc cao (trên 60°C)" },
      { id: "t3", labelJa: "食品の中心部を75℃で1分間以上加熱", labelVi: "Gia nhiệt phần lõi thực phẩm đạt 75°C trong ít nhất 1 phút" },
      ],
    explanationVi:
      "3 nguyên tắc có biện pháp cụ thể khác nhau: つけない chủ yếu qua vệ sinh cá nhân/dụng cụ (đặc biệt quan trọng với vi sinh vật lây liều nhỏ), 増やさない qua kiểm soát NHIỆT ĐỘ BẢO QUẢN (tránh vùng nhiệt độ lý tưởng cho sinh sôi), やっつける qua GIA NHIỆT khi nấu — dễ nhầm giữa 増やさない (bảo quản LẠNH/NÓNG để ngăn sinh sôi) và やっつける (GIA NHIỆT để tiêu diệt hẳn) vì cả hai đều liên quan đến nhiệt độ.",
  },
  {
    id: "mt-hy5-1",
    chapterId: "hy-ch5",
    instructionJa: "次の3つの解凍方法を、それぞれ正しい特徴に当てはめてください。",
    instructionVi: "Hãy ghép đúng 3 phương pháp rã đông sau đây với đặc điểm tương ứng.",
    items: [
      {
        id: "reizoko_kaitou",
        ja: "冷蔵庫内解凍",
        vi: "Rã đông trong tủ lạnh",
        targetId: "t1",
        sourceQuoteJa: "冷蔵庫内で解凍：冷蔵庫内の空気の対流によって低温環境で解凍するため、時間がかかりますが、品質の保持、細菌増殖の抑制に適しています。",
        sourcePage: 32,
      },
      {
        id: "shizen_kaitou",
        ja: "自然・室温解凍",
        vi: "Rã đông tự nhiên/nhiệt độ phòng",
        targetId: "t2",
        sourceQuoteJa: "自然・室温解凍：食材の表面で細菌が増殖する機会を与えることになるため、衛生管理上おこなってはいけない解凍方法です。",
        sourcePage: 32,
      },
      {
        id: "denshi_range_kaitou",
        ja: "電子レンジ解凍",
        vi: "Rã đông bằng lò vi sóng",
        targetId: "t3",
        sourceQuoteJa: "電子レンジ解凍：短時間で解凍できるため便利ですが、解凍ムラができやすいので注意が必要です。",
        sourcePage: 32,
      },
    ...
    targets: [
      { id: "t1", labelJa: "時間はかかるが品質保持・細菌抑制に適する", labelVi: "Tốn thời gian nhưng giữ chất lượng, ức chế vi khuẩn tốt" },
      { id: "t2", labelJa: "衛生管理上おこなってはいけない", labelVi: "Bị cấm về mặt quản lý vệ sinh" },
      { id: "t3", labelJa: "短時間だが解凍ムラができやすい", labelVi: "Nhanh nhưng dễ rã đông không đều" },
    ],
    explanationVi:
      "3 phương pháp rã đông có ưu-nhược khác nhau: tủ lạnh chậm nhưng an toàn nhất (khuyến nghị), nhiệt độ phòng BỊ CẤM vì vi khuẩn dễ sinh sôi trên bề mặt, lò vi sóng nhanh nhưng dễ rã đông không đều — không có phương pháp nào hoàn hảo tuyệt đối.",
  },
  {
    id: "mt-hy4-1",
    chapterId: "hy-ch4",
    instructionJa: "次の5つの用語（作業・洗浄剤）を、それぞれ正しい目的・用途に当てはめてください。",
    instructionVi: "Hãy ghép đúng 5 thuật ngữ (thao tác/chất tẩy rửa) sau đây với mục đích/công dụng tương ứng.",
    items: [
      {
        id: "senjou",
        ja: "洗浄",
        vi: "Rửa",
        targetId: "t1",
        sourceQuoteJa: "汚れや異物を落とす目的であれば「洗浄」をおこないます。また、有害微生物を除きたい場合には「消毒」をおこないます。",
        sourcePage: 10,
      },
      {
        id: "shoudoku",
    ...
    targets: [
      { id: "t1", labelJa: "汚れや異物を落とす", labelVi: "Loại bỏ vết bẩn/dị vật" },
      { id: "t2", labelJa: "有害微生物を除く", labelVi: "Loại bỏ vi sinh vật có hại" },
      { id: "t3", labelJa: "野菜・果物や食器、調理器具などに使用", labelVi: "Dùng cho rau quả, bát đĩa, dụng cụ nấu" },
      { id: "t4", labelJa: "重度の油汚れに使用", labelVi: "Dùng cho vết dầu mỡ nặng" },
      { id: "t5", labelJa: "スケール（水垢）除去に使用", labelVi: "Dùng loại bỏ cặn khoáng (vôi hóa)" },
    ],
    explanationVi:
      "洗浄 (loại bỏ vết bẩn) khác 消毒 (loại bỏ vi sinh vật) — không thể thay thế nhau. 3 loại chất tẩy rửa cũng có công dụng riêng: trung tính cho dụng cụ hàng ngày, kiềm cho dầu mỡ nặng, axit riêng cho cặn khoáng — dùng sai loại sẽ không đạt hiệu quả hoặc hỏng bề mặt.",
  },
  {
    id: "mt-sm4-1",
    chapterId: "sm-ch4",
    instructionJa: "次の6つの販売促進施策を、それぞれ正しい目的に当てはめてください。",
    instructionVi: "Hãy ghép đúng 6 biện pháp xúc tiến bán hàng sau đây với mục đích tương ứng.",
    items: [
      {
        id: "setto_waribiki",
        ja: "セット割引商品",
        vi: "Sản phẩm giảm giá theo set",
        targetId: "t1",
        sourceQuoteJa: "特にランチセットなどは注文を集中させることができます。その結果、料理の提供が早くなり、回転率が上がり売上が向上することになります。",
        sourcePage: 16,
      },
      {
        id: "jikantai_waribiki",
        ja: "時間帯割引商品",
        vi: "Sản phẩm giảm giá theo khung giờ",
        targetId: "t2",
        sourceQuoteJa: "時間帯割引商品は、アイドルタイム（食事時間帯以外）用に値引き商品を置くことで来店客の誘引につなげます。",
        sourcePage: 17,
      },
      {
        ...
        vi: "Phiếu giảm giá",
        targetId: "t3",
        sourceQuoteJa: "割引券の目的は再来店を促すためのもので、レジ精算時に渡します。ただし、来店時に渡すと単純に値引きをしているだけに過ぎないので、売上を下げる要因になります。",
        sourcePage: 17,
      },
      {
        id: "point_seido",
        ...
        vi: "Chế độ tích điểm",
        targetId: "t4",
        sourceQuoteJa: "ポイント制度はお客様を囲い込むための施策で、複数回の来店を促すものです。割引券とともにリピーターの獲得に有効です。",
        sourcePage: 17,
      },
      {
        id: "web_site",
        ...
        vi: "Website",
        targetId: "t5",
        sourceQuoteJa: "WEBサイトは主にホームページになりますが、そこに割引券などを張り付けることによって、新規顧客を獲得する手段として有効です。",
        sourcePage: 17,
      },
      {
        id: "takuhai_service",
        ...
        targetId: "t6",
        sourceQuoteJa: "宅配サービスはWEBと一体で、WEBから注文を受け、宅配業者に配達してもらうことにより、来店動機がない人にも販売できます。やはり新規顧客開拓につながります。",
        sourcePage: 17,
      },
    ],
    targets: [
      { id: "t1", labelJa: "注文集中→提供が早い→回転率アップ", labelVi: "Tập trung đơn hàng → phục vụ nhanh → tăng tỷ lệ quay vòng bàn" },
      { id: "t2", labelJa: "アイドルタイムに来店客を誘引", labelVi: "Thu hút khách vào khung giờ vắng" },
      { id: "t3", labelJa: "再来店を促す（レジ精算時に渡す）", labelVi: "Khuyến khích quay lại lần sau (đưa lúc thanh toán)" },
      { id: "t4", labelJa: "お客様を囲い込み複数回来店を促す", labelVi: "Giữ chân khách, khuyến khích quay lại nhiều lần" },
      { id: "t5", labelJa: "新規顧客を獲得する手段", labelVi: "Công cụ thu hút khách hàng mới" },
      { id: "t6", labelJa: "来店動機がない人にも販売", labelVi: "Bán được cho người không có ý định đến quán" },
    ],
    explanationVi:
      "6 biện pháp xúc tiến bán hàng có mục đích khác nhau rõ rệt: một số nhắm vào tăng回転率 (set giảm giá), một số nhắm vào khung giờ vắng, một số nhắm vào GIỮ CHÂN khách cũ (phiếu giảm giá/tích điểm — khác nhau ở cách đưa/tần suất), và một số nhắm vào THU HÚT khách MỚI (web/giao hàng tận nơi) — dễ nhầm giữa 割引券 (đưa lúc thanh toán, khuyến khích quay lại) và ポイント制度 (giữ chân dài hạn qua nhiều lượt).",
  },
  {
    id: "mt-sm1-1",
    chapterId: "sm-ch1",
    instructionJa: "外食産業を成功させるために必要な「QSCA+H」の5要素を、それぞれ正しい意味に当てはめてください。",
    instructionVi: "Hãy ghép đúng 5 yếu tố trong mô hình \"QSCA+H\" với ý nghĩa tương ứng.",
    items: [
      {
        id: "quality",
        ja: "Quality（Q）",
        vi: "Quality (Q)",
        targetId: "t1",
        sourceQuoteJa: "外食産業として成功するためには、QSC（Quality＝商品の品質、Service＝心のこもったサービス、Cleanliness＝清潔さ）が不可欠です。",
        sourcePage: 1,
      },
      {
        id: "service",
    ...
    targets: [
      { id: "t1", labelJa: "商品の品質", labelVi: "Chất lượng món ăn" },
      { id: "t2", labelJa: "心のこもったサービス", labelVi: "Dịch vụ tận tâm" },
      { id: "t3", labelJa: "清潔さ", labelVi: "Sự sạch sẽ" },
      { id: "t4", labelJa: "業態に見合ったBGMや照明などの雰囲気", labelVi: "Bầu không khí (nhạc nền, ánh sáng...) phù hợp mô hình quán" },
      { id: "t5", labelJa: "お客様の喜びを自分の喜びとする心", labelVi: "Tinh thần lấy niềm vui của khách làm niềm vui của chính mình" },
    ],
    explanationVi:
      "QSC là 3 yếu tố cốt lõi (Q=chất lượng, S=dịch vụ, C=sạch sẽ); A (Atmosphere=bầu không khí) và H (Hospitality=tinh thần hiếu khách) là 2 yếu tố bổ sung tạo thành mô hình đầy đủ QSCA+H — dễ nhầm giữa S (dịch vụ nói chung) và H (tinh thần cụ thể đặt niềm vui khách lên hàng đầu).",
  },
  {
    id: "mt-sm2-1",
    chapterId: "sm-ch2",
    instructionJa: "次の4つの経営指標を、それぞれ正しい計算式に当てはめてください。",
    instructionVi: "Hãy ghép đúng 4 chỉ số kinh doanh sau đây với công thức tính tương ứng.",
    items: [
      {
        id: "jinjiseisansei",
        ja: "人時生産性",
        vi: "Năng suất theo giờ công",
        targetId: "t1",
        sourceQuoteJa: "１日の粗利益÷１日の総労働時間=人時生産性",
        sourcePage: 4,
      },
      {
        id: "roudoubunpairitsu",
        ja: "労働分配率",
        vi: "Tỷ lệ phân phối lao động",
        targetId: "t2",
        sourceQuoteJa: "労働分配率とは粗利益に占める人件費の割合です。",
        sourcePage: 4,
      },
      ...
      },
      {
        id: "kyakutanka",
        ja: "客単価",
        vi: "Đơn giá trung bình mỗi khách",
        targetId: "t4",
        sourceQuoteJa: "客単価＝注文点数×一品平均単価",
        sourcePage: 6,
      },
    ...
    targets: [
      { id: "t1", labelJa: "粗利益 ÷ 総労働時間", labelVi: "Lợi nhuận gộp ÷ Tổng giờ lao động" },
      { id: "t2", labelJa: "粗利益に占める人件費の割合", labelVi: "Tỷ lệ nhân công phí trong lợi nhuận gộp" },
      { id: "t3", labelJa: "原価高 ÷ 売上高 × 100", labelVi: "Giá vốn ÷ Doanh thu × 100" },
      { id: "t4", labelJa: "注文点数 × 一品平均単価", labelVi: "Số món gọi × Đơn giá trung bình mỗi món" },
    ],
    explanationVi:
      "4 chỉ số dễ nhầm vì đều liên quan đến \"chia cho 1 đại lượng khác\": 人時生産性 chia cho GIỜ LAO ĐỘNG, 労働分配率 là TỶ LỆ (không phải phép chia hoàn chỉnh mà là phần trăm cấu thành), 原価率 chia cho DOANH THU, còn 客単価 lại là phép NHÂN chứ không phải chia.",
  },
  {
    id: "mt-sm7-1",
    chapterId: "sm-ch7",
    instructionJa: "人材育成の基本体系4段階を、それぞれ正しい意味に当てはめてください。",
    instructionVi: "Hãy ghép đúng 4 giai đoạn của hệ thống đào tạo nhân sự cơ bản với ý nghĩa tương ứng.",
    items: [
      {
        id: "kyouiku",
        ja: "教育",
    ...
    targets: [
      { id: "t1", labelJa: "芽を引き出す", labelVi: "Khơi gợi mầm non/tiềm năng" },
      { id: "t2", labelJa: "方向付ける", labelVi: "Định hướng" },
      { id: "t3", labelJa: "反復練習する", labelVi: "Luyện tập lặp lại" },
      { id: "t4", labelJa: "開発する", labelVi: "Phát triển" },
    ],
    explanationVi:
      "4 giai đoạn đào tạo theo đúng thứ tự thực hiện: 教育 (khơi gợi tiềm năng) → 導入 (định hướng) → 訓練 (luyện tập lặp lại) → 啓発 (phát triển thêm) — dễ nhầm vì 教育/啓発 đều có thể hiểu chung chung là \"giáo dục/phát triển\" nếu không nhớ rõ định nghĩa riêng từng giai đoạn.",
  },
  {
    id: "mt-sm6-1",
    chapterId: "sm-ch6",
    instructionJa: "次の5つの割増賃金の適用場面を、それぞれ正しい割増率に当てはめてください。",
    instructionVi: "Hãy ghép đúng 5 trường hợp lao động sau đây với tỷ lệ lương phụ trội tương ứng.",
    items: [
      {
        id: "jikangai",
        ja: "週40時間を超えた労働（時間外労働）",
        vi: "Lao động vượt quá 40 giờ/tuần (làm thêm giờ thông thường)",
        targetId: "t25",
        sourceQuoteJa: "週４０時間を超えた労働（時間外労働）時間は割増賃金（２５％以上）を支払う必要があります。",
        sourcePage: 18,
      },
      {
        id: "shinya",
        ja: "22時から翌朝5時の労働（深夜労働、単独）",
        vi: "Lao động từ 22h đến 5h sáng hôm sau (ban đêm, đơn lẻ)",
        targetId: "t25",
        sourceQuoteJa: "また、２２時から翌朝５時の間の労働（深夜労働）時間にも割増賃金（２５％以上）を支払う必要があり",
        sourcePage: 18,
      },
      {
        id: "zangyo60",
        ja: "残業時間が月60時間を超えた部分",
        vi: "Phần giờ làm thêm vượt quá 60 giờ/tháng",
        targetId: "t50",
        sourceQuoteJa: "残業時間が月６０時間までは通常の割増賃金となりますが、それを超えた時間は５０％の割増賃金となります。",
        sourcePage: 18,
      },
      {
        id: "kyujitsu_shinya",
        ja: "休日労働と深夜労働が重複",
        vi: "Lao động ngày nghỉ trùng với lao động ban đêm",
        targetId: "t60",
        sourceQuoteJa: "休日労働と重複する場合：６０%以上（休日労働＋深夜労働）",
        sourcePage: 18,
      },
      {
        id: "choka60_shinya",
        ja: "月超60時間残業労働と深夜労働が重複",
        vi: "Làm thêm giờ vượt quá 60 giờ/tháng trùng với lao động ban đêm",
        targetId: "t75",
        sourceQuoteJa: "月超６０時間残業労働と重複する場合：７５%以上（超６０時間残業＋深夜労働）",
        sourcePage: 18,
      },
    ...
    targets: [
      { id: "t25", labelJa: "25%以上", labelVi: "Từ 25% trở lên (mức cơ bản)" },
      { id: "t50", labelJa: "50%以上", labelVi: "Từ 50% trở lên" },
      { id: "t60", labelJa: "60%以上", labelVi: "Từ 60% trở lên" },
      { id: "t75", labelJa: "75%以上", labelVi: "Từ 75% trở lên (mức cao nhất)" },
    ],
    explanationVi:
      "Bảng phụ trội lương dễ nhầm vì có nhiều mức chồng lấn: làm thêm giờ thông thường VÀ lao động ban đêm đơn lẻ đều chỉ 25% (không cộng dồn thành 50% trừ khi TRÙNG NHAU cùng lúc); làm thêm vượt 60h/tháng riêng lẻ là 50%; nghỉ+đêm trùng nhau là 60%; mức cao nhất 75% chỉ khi CẢ BA điều kiện (vượt 60h + đêm) trùng nhau.",
  },
  {
    id: "mt-sm8-1",
    chapterId: "sm-ch8",
...
export const FILLBLANKS: FillBlankQuestion[] = [
  ...
  },
  {
    id: "fb-sm1-1",
    chapterId: "sm-ch1",
    sentenceJa: "外食産業として成功するためには、QSC（Quality＝商品の品質、Service＝心のこもったサービス、Cleanliness＝＿＿＿）が不可欠です。",
    sentenceVi: "Trong mô hình QSC, chữ \"C\" (Cleanliness) đại diện cho điều gì?",
    options: ["雰囲気", "接客態度", "清潔さ", "価格"],
    correctIndex: 2,
    explanationVi: "QSC = Quality (chất lượng món ăn) + Service (dịch vụ tận tâm) + Cleanliness (sạch sẽ — 清潔さ).",
    sourceQuoteJa: "外食産業として成功するためには、QSC（Quality＝商品の品質、Service＝心のこもったサービス、Cleanliness＝清潔さ）が不可欠です。",
    sourcePage: 1,
  },
  {
    id: "fb-sm1-2",
    chapterId: "sm-ch1",
    sentenceJa: "時間帯責任者は、店舗オペレーションのデイリーワークの中で時間帯における＿＿＿の職務を代行する人です。",
    sentenceVi: "Người phụ trách theo khung giờ (時間帯責任者) là người thay mặt cho chức vụ nào trong công việc vận hành cửa hàng hàng ngày?",
    options: ["店長", "本部長", "調理長", "警備員"],
    correctIndex: 0,
    explanationVi: "時間帯責任者 thay mặt cửa hàng trưởng (店長) thực hiện chức trách trong khung giờ được phân công.",
    sourceQuoteJa: "時間帯責任者は、店舗オペレーションのデイリーワークの中で時間帯における店長の職務を代行する人です。",
    sourcePage: 1,
  },
  {
    id: "fb-sm1-3",
    chapterId: "sm-ch1",
    sentenceJa: "早く出す・・・ランチ6～8分以内、ディナー＿＿＿分以内（居酒屋、焼き肉店などは最初の1品が5分以内）",
    sentenceVi: "Theo tiêu chuẩn \"phục vụ nhanh\", bữa tối (ディナー) cần phục vụ trong tối đa bao nhiêu phút?",
    options: ["20", "12", "15", "8"],
    correctIndex: 1,
    explanationVi: "Chuẩn 'phục vụ nhanh': bữa trưa 6-8 phút, bữa tối 12 phút (riêng quán nhậu/nướng thịt thì món đầu 5 phút).",
    sourceQuoteJa: "早く出す・・・ランチ6～8分以内、ディナー12分以内（居酒屋、焼き肉店などは最初の1品が5分以内）",
    sourcePage: 2,
  },
  {
    id: "fb-sm1-4",
    chapterId: "sm-ch1",
    sentenceJa: "外食産業の店舗の運営について責任のある人（店舗責任者）は、店長、副店長、店長代理、＿＿＿などと呼ばれています。",
    sentenceVi: "Ngoài cửa hàng trưởng/phó cửa hàng trưởng/người đại diện, người chịu trách nhiệm cửa hàng còn được gọi bằng chức danh nào khác?",
    options: ["本部長", "調理長", "警備責任者", "時間帯責任者"],
    correctIndex: 3,
    explanationVi: "4 chức danh được liệt kê: 店長, 副店長, 店長代理, 時間帯責任者 — không có \"本部長\".",
    sourceQuoteJa: "外食産業の店舗の運営について責任のある人（店舗責任者）は、店長、副店長、店長代理、時間帯責任者などと呼ばれています。",
    sourcePage: 1,
  },
  {
    id: "fb-sm3-1",
    chapterId: "sm-ch3",
    sentenceJa: "発注は[各食材の＿＿＿－各食材の発注時点での在庫量＝各食材の発注量]として納入業者別におこないます。",
    sentenceVi: "Công thức tính lượng đặt hàng lấy đại lượng nào (tại từng nguyên liệu) trừ đi tồn kho hiện tại tại thời điểm đặt hàng?",
    options: ["安全在庫量", "適正在庫量", "目標在庫量", "平均在庫量"],
    correctIndex: 1,
    explanationVi: "発注量 = Lượng tồn kho hợp lý (適正在庫量) cần có − Lượng tồn kho thực tế tại thời điểm đặt hàng.",
    sourceQuoteJa: "発注は[各食材の適正在庫量－各食材の発注時点での在庫量＝各食材の発注量]として納入業者別におこないます。",
    sourcePage: 13,
  },
  {
    id: "fb-sm3-2",
    chapterId: "sm-ch3",
    sentenceJa: "実地棚卸しは、発注量の決定や在庫品の品質管理のためにも＿＿＿実施する必要があります。",
    sentenceVi: "Kiểm kê thực tế (実地棚卸し) cần được thực hiện với tần suất nào để phục vụ quyết định lượng đặt hàng và quản lý chất lượng?",
    options: ["毎週", "毎月", "毎日", "毎年"],
    correctIndex: 2,
    explanationVi: "実地棚卸し phải thực hiện HÀNG NGÀY (毎日) để phục vụ quyết định lượng đặt hàng và quản lý chất lượng hàng tồn.",
    sourceQuoteJa: "実地棚卸しは、発注量の決定や在庫品の品質管理のためにも毎日実施する必要があります。",
    sourcePage: 14,
  },
  {
    id: "fb-sm3-3",
    chapterId: "sm-ch3",
    sentenceJa: "基本は＿＿＿（発注書やそのコピー）を元にして、検品を実施しなければなりません。",
    sentenceVi: "Kiểm hàng (検品) về cơ bản phải dựa trên đại lượng nào (đơn đặt hàng hoặc bản sao) để thực hiện?",
    options: ["発注量", "納品量", "在庫量", "予算額"],
    correctIndex: 0,
    explanationVi: "Kiểm hàng phải dựa trên lượng đặt hàng (発注量 — đơn đặt hàng gốc hoặc bản sao) làm căn cứ gốc.",
    sourceQuoteJa: "基本は発注量（発注書やそのコピー）を元にして、検品を実施しなければなりません。",
    sourcePage: 15,
  },
  {
    id: "fb-sm3-4",
    chapterId: "sm-ch3",
    sentenceJa: "エ 収納は決めた場所におこない、＿＿＿を徹底する。",
    sentenceVi: "Khi thu kho, nguyên tắc sắp xếp hàng nào cần tuân thủ triệt để?",
    options: ["後入れ先出し", "ランダムに配置", "高価品優先取出し", "先入れ先出し"],
    correctIndex: 3,
    explanationVi: "Nguyên tắc thu kho: xuất hàng cũ trước (先入れ先出し / FIFO), cất đúng vị trí đã quy định.",
    sourceQuoteJa: "エ 収納は決めた場所におこない、先入れ先出しを徹底する。",
    sourcePage: 15,
  },
  {
    id: "fb-sm3-5",
    chapterId: "sm-ch3",
    sentenceJa: "それは発注した量より多ければ＿＿＿が発生し、品質が劣化して使用できずロスとなるからです。",
    sentenceVi: "Nếu lượng giao hàng thực tế nhiều hơn lượng đặt, vấn đề gì phát sinh khiến hàng hóa dần suy giảm chất lượng và thành hao hụt?",
    options: ["品切れ", "売れ残り", "返品", "値引き"],
    correctIndex: 1,
    explanationVi: "Giao nhiều hơn đặt → hàng tồn không bán hết (売れ残り), chất lượng suy giảm theo thời gian, cuối cùng phải bỏ đi (ロス) — khác với 品切れ (hết hàng, xảy ra khi giao ÍT hơn).",
    sourceQuoteJa: "それは発注した量より多ければ売れ残りが発生し、品質が劣化して使用できずロスとなるからです。",
    sourcePage: 15,
  },
  {
    id: "fb-sm4-1",
    chapterId: "sm-ch4",
    sentenceJa: "ABC分析とは全メニューを売上順又は売れ個数順に並べトータルの＿＿＿％を構成するメニューをAとし、７０％から９０％を構成するメニューをBとし、９０％から１００％を構成するメニューをCとします。",
    sentenceVi: "Trong phân tích ABC, nhóm A gồm những món chiếm bao nhiêu % đầu tiên (tính theo doanh thu/số lượng bán cộng dồn)?",
    options: ["７０", "６０", "８０", "５０"],
    correctIndex: 0,
    explanationVi: "ABC分析: nhóm A = 70% đầu (tính theo doanh thu/số lượng bán cộng dồn), nhóm B = 70-90%, nhóm C = 90-100%.",
    sourceQuoteJa: "ABC分析とは全メニューを売上順又は売れ個数順に並べトータルの７０％を構成するメニューをAとし、７０％から９０％を構成するメニューをBとし、９０％から１００％を構成するメニューをCとします。",
    sourcePage: 16,
  },
  {
    id: "fb-sm4-2",
    chapterId: "sm-ch4",
    sentenceJa: "割引券の目的は再来店を促すためのもので、＿＿＿に渡します。ただし、来店時に渡すと単純に値引きをしているだけに過ぎないので、売上を下げる要因になります。",
    sentenceVi: "Phiếu giảm giá nên được đưa vào thời điểm nào để tránh chỉ là giảm giá đơn thuần làm giảm doanh thu?",
    options: ["来店時", "レジ精算時", "閉店後", "翌日"],
    correctIndex: 1,
    explanationVi: "Phiếu giảm giá nhằm khuyến khích khách QUAY LẠI lần sau, nên phải đưa lúc thanh toán (レジ精算時) — đưa ngay lúc khách vào chỉ là giảm giá đơn thuần.",
    sourceQuoteJa: "割引券の目的は再来店を促すためのもので、レジ精算時に渡します。ただし、来店時に渡すと単純に値引きをしているだけに過ぎないので、売上を下げる要因になります。",
    sourcePage: 17,
  },
  {
    id: "fb-sm4-3",
    chapterId: "sm-ch4",
    sentenceJa: "ポイント制度はお客様を＿＿＿ための施策で、複数回の来店を促すものです。",
    sentenceVi: "Chế độ tích điểm (ポイント制度) là biện pháp nhằm mục đích gì đối với khách hàng, để khuyến khích quay lại nhiều lần?",
    options: ["新規開拓する", "囲い込む", "評価する", "分析する"],
    correctIndex: 1,
    explanationVi: "ポイント制度 nhằm giữ chân khách (囲い込む), khuyến khích quay lại nhiều lần.",
    sourceQuoteJa: "ポイント制度はお客様を囲い込むための施策で、複数回の来店を促すものです。割引券とともにリピーターの獲得に有効です。",
    sourcePage: 17,
  },
  {
    id: "fb-sm4-4",
    chapterId: "sm-ch4",
    sentenceJa: "特にランチセットなどは注文を集中させることができます。その結果、料理の提供が早くなり、＿＿＿が上がり売上が向上することになります。",
    sentenceVi: "Set trưa giúp đơn hàng tập trung, phục vụ nhanh hơn, làm tăng chỉ số nào rồi từ đó tăng doanh thu?",
    options: ["原価率", "労働分配率", "客単価", "回転率"],
    correctIndex: 3,
    explanationVi: "Set trưa làm đơn hàng tập trung → bếp phục vụ nhanh hơn → tỷ lệ quay vòng bàn (回転率) tăng → doanh thu tăng.",
    sourceQuoteJa: "特にランチセットなどは注文を集中させることができます。その結果、料理の提供が早くなり、回転率が上がり売上が向上することになります。",
    sourcePage: 16,
  },
  {
    id: "fb-sm4-5",
    chapterId: "sm-ch4",
    sentenceJa: "宅配サービスはWEBと一体で、WEBから注文を受け、宅配業者に配達してもらうことにより、＿＿＿にも販売できます。",
    sentenceVi: "Dịch vụ giao hàng tận nơi giúp bán được cho nhóm khách nào, mở rộng khách hàng mới?",
    options: ["常連客", "来店動機がない人", "従業員", "取引先"],
    correctIndex: 1,
    explanationVi: "宅配サービス bán được cho cả người không có ý định đến quán trực tiếp (来店動機がない人), mở rộng khách hàng mới.",
    sourceQuoteJa: "宅配サービスはWEBと一体で、WEBから注文を受け、宅配業者に配達してもらうことにより、来店動機がない人にも販売できます。やはり新規顧客開拓につながります。",
    sourcePage: 17,
  },
  {
    id: "fb-sm5-1",
    chapterId: "sm-ch5",
    sentenceJa: "客数が減少傾向となる原因は、主に固定顧客と準固定顧客の＿＿＿です。",
    sentenceVi: "Nguyên nhân chính khiến số lượng khách có xu hướng giảm là hiện tượng gì xảy ra với khách quen cố định và khách bán cố định?",
    options: ["目減り", "増加", "分散", "固定化"],
    correctIndex: 0,
    explanationVi: "客数 giảm chủ yếu do sự SỤT GIẢM (目減り) của khách quen cố định và khách bán cố định — không phải do khách mới.",
    sourceQuoteJa: "客数が減少傾向となる原因は、主に固定顧客と準固定顧客の目減りです。",
    sourcePage: 17,
  },
  {
    id: "fb-sm5-2",
    chapterId: "sm-ch5",
    sentenceJa: "顧客管理とは＿＿＿を固定客に、新規顧客を準固定顧客あるいは固定顧客にしていくことが重要です。",
    sentenceVi: "Quản lý khách hàng (顧客管理) là biến nhóm khách nào thành khách quen cố định, song song với việc nâng cấp khách mới?",
    options: ["一見客", "準固定顧客", "取引先", "従業員"],
    correctIndex: 1,
    explanationVi: "顧客管理 = biến khách bán cố định (準固定顧客) thành khách quen cố định, biến khách mới thành khách bán cố định hoặc khách quen cố định.",
    sourceQuoteJa: "顧客管理とは準固定顧客を固定客に、新規顧客を準固定顧客あるいは固定顧客にしていくことが重要です。",
    sourcePage: 17,
  },
  {
    id: "fb-sm5-3",
    chapterId: "sm-ch5",
    sentenceJa: "準固定顧客を固定顧客にしていくためには、まず＿＿＿ことが大切です。",
    sentenceVi: "Để biến khách bán cố định thành khách quen cố định, điều quan trọng cần làm trước tiên là gì?",
    options: ["割引券を配る", "価格を下げる", "顔をできるだけ思い出す", "来店を制限する"],
    correctIndex: 2,
    explanationVi: "Trước tiên cần cố gắng nhớ lại mặt khách bán cố định (顔をできるだけ思い出す), rồi chào hỏi như với khách quen cố định.",
    sourceQuoteJa: "準固定顧客を固定顧客にしていくためには、まず顔をできるだけ思い出すことが大切です。準固定顧客の顔を思い出して固定顧客同様にあいさつすれば来店頻度が増えていきます。",
    sourcePage: 17,
  },
  {
    id: "fb-sm5-4",
    chapterId: "sm-ch5",
    sentenceJa: "新規顧客には、＿＿＿ことにより、再来店してもらえることに繋がります。",
    sentenceVi: "Với khách hàng mới, làm điều gì sẽ dẫn đến khả năng họ quay lại lần sau?",
    options: ["値引きを強く迫る", "QSCレベルを全体的に上げていく", "情報を記録しない", "優先的に扱わない"],
    correctIndex: 1,
    explanationVi: "Với khách mới, nâng cao toàn diện mức QSC (QSCレベルを全体的に上げていく) là điều dẫn đến khả năng họ quay lại.",
    sourceQuoteJa: "新規顧客には、QSCレベルを全体的に上げていくことにより、再来店してもらえることに繋がります。",
    sourcePage: 17,
  },
  {
    id: "fb-sm5-5",
    chapterId: "sm-ch5",
    sentenceJa: "＿＿＿と、その口コミで新規顧客として来店してもらえる機会につながります。",
    sentenceVi: "Nhờ đâu mà tin truyền miệng lan tỏa, tạo cơ hội cho khách hàng mới đến quán?",
    options: ["広告費を大量に投入する", "SNSを完全に停止する", "既存客を減らす", "友人や知人に推奨してもらえる"],
    correctIndex: 3,
    explanationVi: "Khi khách hàng được bạn bè/người quen giới thiệu (友人や知人に推奨してもらえる), tin truyền miệng đó tạo cơ hội cho khách hàng mới đến quán.",
    sourceQuoteJa: "また、友人や知人に推奨してもらえると、その口コミで新規顧客として来店してもらえる機会につながります。",
    sourcePage: 17,
  },
  {
    id: "fb-sm6-1",
    chapterId: "sm-ch6",
    sentenceJa: "使用者は原則として、１日８時間、１週当たり＿＿＿時間（商業、映画・演劇業（映画製作の事業を除く）、保健衛生業及び接客娯楽業（飲食店など）であって、常時使用する労働者が１０人未満の事業場は、１週当たり４４時間）以内で労働者を働かせなければなりません。",
    sentenceVi: "Nguyên tắc chung, người sử dụng lao động được cho làm việc 1 ngày 8 giờ, 1 tuần tối đa bao nhiêu giờ (riêng vài ngành dưới 10 lao động thì 44 giờ)?",
    options: ["３５", "４０", "４４", "４８"],
    correctIndex: 1,
    explanationVi: "Nguyên tắc chung: 1 ngày 8 giờ, 1 tuần 40 giờ — riêng ngành thương mại/điện ảnh/y tế/dịch vụ ăn uống-giải trí với dưới 10 lao động thường xuyên thì 1 tuần 44 giờ (ngoại lệ, không phải nguyên tắc chung).",
    sourceQuoteJa:
      "使用者は原則として、１日８時間、１週当たり４０時間（商業、映画・演劇業（映画製作の事業を除く）、保健衛生業及び接客娯楽業（飲食店など）であって、常時使用する労働者が１０人未満の事業場は、１週当たり４４時間）以内で労働者を働かせなければなりません。",
    sourcePage: 18,
  },
  {
    id: "fb-sm6-2",
    chapterId: "sm-ch6",
    sentenceJa: "週４０時間を超えた労働（時間外労働）時間は割増賃金（＿＿＿％以上）を支払う必要があります。",
    sentenceVi: "Lao động vượt quá 40 giờ/tuần (làm thêm giờ thông thường) cần trả lương phụ trội tối thiểu bao nhiêu %?",
    options: ["１０", "２５", "５０", "７５"],
    correctIndex: 1,
    explanationVi: "Lao động vượt 40 giờ/tuần (時間外労働) cần trả lương phụ trội tối thiểu 25% — mức cơ bản, thấp nhất trong bảng phụ trội.",
    sourceQuoteJa: "週４０時間を超えた労働（時間外労働）時間は割増賃金（２５％以上）を支払う必要があります。",
    sourcePage: 18,
  },
  {
    id: "fb-sm6-3",
    chapterId: "sm-ch6",
    sentenceJa: "ただし、労働時間の延長は、１か月＿＿＿時間、１年３６０時間以内で定めることが原則です。",
    sentenceVi: "Nguyên tắc, việc kéo dài giờ lao động tối đa bao nhiêu giờ/tháng (và 360 giờ/năm)?",
    options: ["３０", "４５", "６０", "１００"],
    correctIndex: 1,
    explanationVi: "Nguyên tắc: kéo dài giờ lao động tối đa 45 giờ/tháng, 360 giờ/năm.",
    sourceQuoteJa: "ただし、労働時間の延長は、１か月４５時間、１年３６０時間以内で定めることが原則です。",
    sourcePage: 18,
  },
  {
    id: "fb-sm6-4",
    chapterId: "sm-ch6",
    sentenceJa: "休日労働と重複する場合：＿＿＿%以上（休日労働＋深夜労働）",
    sentenceVi: "Khi lao động ngày nghỉ trùng với lao động ban đêm, tỷ lệ phụ trội tối thiểu bao nhiêu %?",
    options: ["２５", "５０", "６０", "７５"],
    correctIndex: 2,
    explanationVi: "休日労働＋深夜労働 (lao động ngày nghỉ + ban đêm) trùng nhau: tỷ lệ phụ trội tối thiểu 60%.",
    sourceQuoteJa: "休日労働と重複する場合：６０%以上（休日労働＋深夜労働）",
  ...
  },
  {
    id: "fb-sm6-5",
    chapterId: "sm-ch6",
    sentenceJa: "月超６０時間残業労働と重複する場合：＿＿＿%以上（超６０時間残業＋深夜労働）",
    sentenceVi: "Khi làm thêm giờ vượt quá 60 giờ/tháng trùng với lao động ban đêm, tỷ lệ phụ trội tối thiểu bao nhiêu %?",
    options: ["５０", "６０", "７５", "１００"],
    correctIndex: 2,
    explanationVi: "Đây là mức phụ trội cao nhất trong bảng: 超60時間残業＋深夜労働 (làm thêm vượt 60h/tháng + ban đêm) = tối thiểu 75%.",
    sourceQuoteJa: "月超６０時間残業労働と重複する場合：７５%以上（超６０時間残業＋深夜労働）",
    sourcePage: 18,
  },
  {
    id: "fb-sm7-1",
    chapterId: "sm-ch7",
    sentenceJa: "この段階は＿＿＿が担当する必要があります。",
    sentenceVi: "4 giai đoạn đào tạo nhân sự cơ bản (教育・導入・訓練・啓発) cần do ai chỉ đạo?",
    options: ["新人アルバイト", "店や職場の責任者（マネージャー）", "本部の経理担当者", "外部のコンサルタント"],
    correctIndex: 1,
    explanationVi: "Việc chỉ đạo 4 giai đoạn cần do người phụ trách cửa hàng/nơi làm việc (マネージャー) đảm nhận.",
    sourceQuoteJa: "この段階は店や職場の責任者（マネージャー）が担当する必要があります。",
    sourcePage: 20,
  },
  {
    id: "fb-sm7-2",
    chapterId: "sm-ch7",
    sentenceJa: "接客サービスの基本は「＿＿＿」を学び、反復練習（トレーニング）をする中で体得することです。",
    sentenceVi: "Nền tảng dịch vụ tiếp khách được tiếp thu bằng cách học điều gì, rồi thấm nhuần qua luyện tập lặp lại?",
    options: ["理論", "型", "資格", "マニュアル全文"],
    correctIndex: 1,
    explanationVi: "接客サービスの基本 được tiếp thu bằng cách học \"khuôn mẫu\" (型) rồi thấm nhuần qua luyện tập lặp lại.",
    sourceQuoteJa: "接客サービスの基本は「型」を学び、反復練習（トレーニング）をする中で体得することです。",
    sourcePage: 20,
  },
  {
    id: "fb-sm7-3",
    chapterId: "sm-ch7",
    sentenceJa: "サービスを表現する要素は「＿＿＿」です。",
    sentenceVi: "3 yếu tố thể hiện dịch vụ đúng là tổ hợp nào?",
    options: ["価格・品質・清潔さ", "速度・正確さ・丁寧さ", "態度・表情・言葉遣い", "経験・知識・資格"],
    correctIndex: 2,
    explanationVi: "3 yếu tố thể hiện dịch vụ: 態度 (thái độ), 表情 (nét mặt), 言葉遣い (cách dùng từ).",
    sourceQuoteJa: "サービスを表現する要素は「態度・表情・言葉遣い」です。",
    sourcePage: 20,
  },
  {
    id: "fb-sm7-4",
    chapterId: "sm-ch7",
    sentenceJa: "中でもコミュニケーションには、言葉そのものより＿＿＿のほうが大きな影響を及ぼします。",
    sentenceVi: "Trong giao tiếp, điều gì có ảnh hưởng lớn hơn cả bản thân nội dung từ ngữ?",
    options: ["文法の正確さ", "話す速度", "言葉遣いや表情", "使用する単語数"],
    correctIndex: 2,
    explanationVi: "Trong giao tiếp, 言葉遣いや表情 (cách dùng từ và nét mặt) có ảnh hưởng lớn hơn chính bản thân nội dung từ ngữ.",
    sourceQuoteJa: "中でもコミュニケーションには、言葉そのものより言葉遣いや表情のほうが大きな影響を及ぼします。",
    sourcePage: 20,
  },
  {
    id: "fb-sm7-5",
    chapterId: "sm-ch7",
    sentenceJa: "⑤ ＿＿＿ どこからどこまでが対象範囲か",
    sentenceVi: "Trong 7 yếu tố dạy kỹ năng, yếu tố nào chỉ \"phạm vi đối tượng từ đâu đến đâu\"?",
    options: ["方法", "手順", "量", "質"],
    correctIndex: 2,
    explanationVi: "「量」 = phạm vi đối tượng công việc, từ đâu đến đâu là thuộc phạm vi cần làm — khác với「質」= mức độ hoàn thiện.",
    sourceQuoteJa: "⑤ 量 どこからどこまでが対象範囲か",
  ...
  },
  {
    id: "fb-sm8-1",
    chapterId: "sm-ch8",
    sentenceJa: "防火管理者とは、多数の者が利用する建物などの「火災等による被害」を防止するため、防火管理についての＿＿＿を作成し、防火管理上必要な業務（防火管理業務）を計画的におこなう責任者を言います。",
    sentenceVi: "Người quản lý phòng cháy (防火管理者) là người lập ra văn bản gì về phòng cháy, rồi thực hiện có kế hoạch các công việc cần thiết?",
    options: ["消防計画", "避難マニュアル", "従業員名簿", "保険契約書"],
    correctIndex: 0,
    explanationVi: "防火管理者 lập kế hoạch phòng cháy (消防計画) và thực hiện có kế hoạch các công việc quản lý phòng cháy.",
    sourceQuoteJa:
      "防火管理者とは、多数の者が利用する建物などの「火災等による被害」を防止するため、防火管理についての消防計画を作成し、防火管理上必要な業務（防火管理業務）を計画的におこなう責任者を言います。",
    sourcePage: 22,
  },
  {
    id: "fb-sm8-2",
    chapterId: "sm-ch8",
    sentenceJa: "防火管理者として選任するための要件は、防火管理業務を適切に遂行することができる「＿＿＿」にある必要があり、そのため店長又はそれに匹敵するものである必要があります。",
    sentenceVi: "Người quản lý phòng cháy cần đáp ứng điều kiện gì về vị trí công việc để đủ điều kiện được chọn?",
    options: ["新入社員的地位", "管理的、監督的地位", "臨時雇用の地位", "外部委託の地位"],
    correctIndex: 1,
    explanationVi: "Người quản lý phòng cháy phải ở vị trí quản lý/giám sát (管理的、監督的地位), tức quản lý cửa hàng hoặc tương đương.",
    sourceQuoteJa:
      "防火管理者として選任するための要件は、防火管理業務を適切に遂行することができる「管理的、監督的地位」にある必要があり、そのため店長又はそれに匹敵するものである必要があります。また、防火管理上必要な「知識・技能」を有している必要があります。",
    sourcePage: 22,
  },
  {
    id: "fb-sm8-3",
    chapterId: "sm-ch8",
    sentenceJa: "防火管理者は、防火管理新規講習などを受講し資格を持っていること、さらに＿＿＿へ防火管理者の選任届出をおこなうことが必要となります。",
    sentenceVi: "Sau khi có chứng chỉ, người quản lý phòng cháy cần nộp thông báo bổ nhiệm cho cơ quan nào?",
    options: ["警察署", "税務署", "消防機関", "労働基準監督署"],
    correctIndex: 2,
    explanationVi: "Cần nộp thông báo bổ nhiệm cho cơ quan phòng cháy chữa cháy (消防機関) sau khi có chứng chỉ.",
    sourceQuoteJa: "防火管理者は、防火管理新規講習などを受講し資格を持っていること、さらに消防機関へ防火管理者の選任届出をおこなうことが必要となります。",
    sourcePage: 22,
  },
  {
    id: "fb-sm8-4",
    chapterId: "sm-ch8",
    sentenceJa: "燃焼三要素は、可燃物（燃えるもの）、酸素（空気）、＿＿＿（ガスの炎、電気の火花、過加熱など）です。",
    sentenceVi: "3 yếu tố cháy gồm vật liệu dễ cháy, oxy, và yếu tố nào (như tia lửa gas, tia lửa điện, quá nhiệt)?",
    options: ["湿度", "熱源", "気圧", "静電気のみ"],
    correctIndex: 1,
    explanationVi: "3 yếu tố cháy: vật liệu dễ cháy (可燃物), oxy (酸素), nguồn nhiệt (熱源 — như tia lửa gas/điện/quá nhiệt).",
    sourceQuoteJa: "燃焼三要素は、可燃物（燃えるもの）、酸素（空気）、熱源（ガスの炎、電気の火花、過加熱など）です。",
    sourcePage: 22,
  },
  {
    id: "fb-sm8-5",
    chapterId: "sm-ch8",
    sentenceJa: "煙は上へ上がるので、＿＿＿ようにし、大きな透明のビニール袋の中に顔を入れて避難することで、有毒ガスから身を守る避難が大切です。",
    sentenceVi: "Vì khói bốc lên trên, cần làm gì với vị trí khuôn mặt khi sơ tán (cùng với đưa mặt vào túi ni-lông trong suốt lớn)?",
    options: ["天井に向ける", "窓の外に出す", "マスクだけで覆う", "床面に近づける"],
    correctIndex: 3,
    explanationVi: "Vì khói bốc lên trên, cần ghé mặt gần sàn nhà (床面に近づける), và dùng túi ni-lông trong suốt lớn trùm đầu để bảo vệ khỏi khí độc.",
    sourceQuoteJa:
      "火災時に命を落とすのは焼死と有毒ガスによる死亡です。煙は上へ上がるので、顔を床面に近づけるようにし、大きな透明のビニール袋の中に顔を入れて避難することで、有毒ガスから身を守る避難が大切です。",
    sourcePage: 23,
  },
  {
    id: "fb-hy1-1",
    chapterId: "hy-ch1",
    sentenceJa: "食品衛生法の第一条では、その目的を「飲食に起因する衛生上の危害の発生を防止し、＿＿＿を図ること」と明記しています。",
    sentenceVi: "Điều 1 Luật Vệ sinh Thực phẩm nêu rõ mục đích là ngăn ngừa nguy hại vệ sinh do ăn uống, và điều gì khác?",
    options: ["国民の健康の保護", "外食産業の発展", "調理師の資格認定", "食材の輸出促進"],
    correctIndex: 0,
    explanationVi: "食品衛生法 Điều 1: ngăn ngừa nguy hại vệ sinh phát sinh từ ăn uống, qua đó bảo vệ sức khỏe toàn dân (国民の健康の保護).",
    sourceQuoteJa: "食品衛生法の第一条では、その目的を「飲食に起因する衛生上の危害の発生を防止し、国民の健康の保護を図ること」と明記しています。",
    sourcePage: 1,
  },
  {
    id: "fb-hy1-2",
    chapterId: "hy-ch1",
    sentenceJa: "近年は＿＿＿件前後の食中毒事件が発生し",
    sentenceVi: "Gần đây, số vụ ngộ độc thực phẩm dao động khoảng bao nhiêu vụ/năm?",
    options: ["１００", "１，０００", "１０，０００", "１００，０００"],
    correctIndex: 1,
    explanationVi: "Gần đây số vụ ngộ độc thực phẩm dao động khoảng 1.000 vụ/năm.",
    sourceQuoteJa: "近年は１，０００件前後の食中毒事件が発生し",
    sourcePage: 1,
  },
  {
    id: "fb-hy1-3",
    chapterId: "hy-ch1",
    sentenceJa: "患者数は平成２５（２０１３）年以降＿＿＿人を下まわり減少傾向が認められます",
    sentenceVi: "Từ năm 2013, số bệnh nhân ngộ độc thực phẩm giảm xuống dưới bao nhiêu người/năm?",
    options: ["２，５００", "２５，０００", "２５０，０００", "２，５００，０００"],
    correctIndex: 1,
    explanationVi: "Từ năm 2013, số bệnh nhân ngộ độc thực phẩm giảm xuống dưới 25.000 người/năm.",
    sourceQuoteJa: "患者数は平成２５（２０１３）年以降２５，０００人を下まわり減少傾向が認められます",
    sourcePage: 1,
  },
  {
    id: "fb-hy1-4",
    chapterId: "hy-ch1",
    sentenceJa: "ほとんどの食中毒（約９０％以上）は、食品を汚染する＿＿＿が原因物質です。",
    sentenceVi: "Trên 90% ngộ độc thực phẩm do nhóm tác nhân nào làm ô nhiễm thực phẩm gây ra?",
    options: ["化学調味料のみ", "食品添加物のみ", "細菌、ウイルス、寄生虫などの有害微生物", "食品の温度変化のみ"],
    correctIndex: 2,
    explanationVi: "Trên 90% ngộ độc thực phẩm do vi sinh vật có hại (vi khuẩn, virus, ký sinh trùng) làm ô nhiễm thực phẩm gây ra.",
    sourceQuoteJa: "ほとんどの食中毒（約９０％以上）は、食品を汚染する細菌、ウイルス、寄生虫などの有害微生物が原因物質です。",
    sourcePage: 1,
  },
  {
    id: "fb-hy1-5",
    chapterId: "hy-ch1",
    sentenceJa: "食中毒は飲食に起因する衛生上の大きな危害ですが、近年は＿＿＿も重要な課題になっています。",
    sentenceVi: "Ngoài ngộ độc thực phẩm, gần đây điều gì khác cũng trở thành thách thức quan trọng?",
    options: ["従業員の離職率", "店舗の駐車場不足", "異物混入によるケガや、食物アレルギー対策", "メニューの多様化"],
    correctIndex: 2,
    explanationVi: "Ngoài ngộ độc thực phẩm, tài liệu nêu rõ 2 thách thức quan trọng khác: chấn thương do dị vật lẫn trong thức ăn và biện pháp phòng ngừa dị ứng thực phẩm.",
    sourceQuoteJa: "食中毒は飲食に起因する衛生上の大きな危害ですが、近年は異物混入によるケガや、食物アレルギー対策も重要な課題になっています。",
    sourcePage: 1,
  },
  {
    id: "fb-hy3-1",
    chapterId: "hy-ch3",
    sentenceJa: "営業許可更新時や保健所による定期的な立入検査などの監視指導時には、「＿＿＿」に基づいて「HACCPに沿った衛生管理」の実施状況の確認を受ける必要があります。",
    sentenceVi: "Khi gia hạn giấy phép kinh doanh hoặc thanh tra định kỳ, việc xác nhận tình trạng thực hiện HACCP dựa trên loại tài liệu nào?",
    options: ["従業員の履歴書", "月次売上報告書", "食品衛生監視票", "メニュー表"],
    correctIndex: 2,
    explanationVi: "食品衛生監視票 (Phiếu giám sát vệ sinh thực phẩm) là căn cứ để cơ quan y tế xác nhận tình trạng thực hiện quản lý vệ sinh theo HACCP.",
    sourceQuoteJa: "営業許可更新時や保健所による定期的な立入検査などの監視指導時には、「食品衛生監視票」に基づいて「HACCPに沿った衛生管理」の実施状況の確認を受ける必要があります。",
    sourcePage: 5,
  },
  {
    id: "fb-hy3-2",
    chapterId: "hy-ch3",
    sentenceJa: "衛生管理計画の作成：「一般的な衛生管理」および「HACCPに沿った衛生管理」に関する基準に基づき衛生管理計画を作成し、＿＿＿。",
    sentenceVi: "Sau khi lập kế hoạch quản lý vệ sinh dựa theo tiêu chuẩn, bước tiếp theo cần làm gì?",
    options: ["秘密にする", "従業員に周知徹底を図る", "二度と変更しない", "本部のみで保管する"],
    correctIndex: 1,
    explanationVi: "Sau khi lập kế hoạch, phải phổ biến triệt để cho toàn thể nhân viên (従業員に周知徹底を図る).",
    sourceQuoteJa: "衛生管理計画の作成：「一般的な衛生管理」および「HACCPに沿った衛生管理」に関する基準に基づき衛生管理計画を作成し、従業員に周知徹底を図る。",
    sourcePage: 5,
  },
  {
    id: "fb-hy3-3",
    chapterId: "hy-ch3",
    sentenceJa: "定期的な検証：衛生管理計画および手順書の効果を＿＿＿（および工程に変更が生じた際などに）検証し（振り返り）、必要に応じて内容を見直す。",
    sentenceVi: "Việc kiểm chứng hiệu quả kế hoạch/quy trình cần thực hiện với tần suất nào (ngoài lúc quy trình thay đổi)?",
    options: ["定期的に", "10年に1回", "税務署の指示があるときのみ", "一度だけ"],
    correctIndex: 0,
    explanationVi: "定期的な検証: định kỳ (定期的に) kiểm chứng hiệu quả kế hoạch/sổ tay hướng dẫn, rồi điều chỉnh nội dung nếu cần.",
    sourceQuoteJa: "定期的な検証：衛生管理計画および手順書の効果を定期的に（および工程に変更が生じた際などに）検証し（振り返り）、必要に応じて内容を見直す。",
    sourcePage: 5,
  },
  {
    id: "fb-hy3-4",
    chapterId: "hy-ch3",
    sentenceJa: "衛生管理基準の弾力的な運用の対象となる飲食店などの小規模営業者は、事業者団体などが作成した「HACCPの考え方を取り入れた衛生管理」の手引書を活用することが可能ですが、その場合には特に＿＿＿が重要になります",
    sentenceVi: "Khi doanh nghiệp nhỏ dùng sổ tay hướng dẫn riêng, điều gì đặc biệt trở nên quan trọng?",
    options: ["独自基準への切り替え", "一般的な衛生管理の基準１４項目の順守", "検証手順の簡略化", "記録保存の省略"],
    correctIndex: 1,
    explanationVi: "Khi dùng sổ tay hướng dẫn riêng, việc tuân thủ đủ 14 hạng mục tiêu chuẩn quản lý vệ sinh chung càng trở nên quan trọng.",
    sourceQuoteJa:
      "衛生管理基準の弾力的な運用の対象となる飲食店などの小規模営業者は、事業者団体などが作成した「HACCPの考え方を取り入れた衛生管理」の手引書を活用することが可能ですが、その場合には特に一般的な衛生管理の基準１４項目の順守が重要になります",
    sourcePage: 5,
  },
  {
    id: "fb-hy3-5",
    chapterId: "hy-ch3",
    sentenceJa: "① 衛生管理計画の作成② ＿＿＿③ 記録と保存：衛生管理の実施状況を記録し、保存する。④ 定期的な検証",
    sentenceVi: "Trong 4 việc bắt buộc để triển khai HACCP, việc thứ 2 (sau lập kế hoạch, trước ghi chép lưu trữ) là gì?",
    options: ["従業員給与の見直し", "メニューの改定", "店舗の改装", "手引書の作成"],
    correctIndex: 3,
    explanationVi: "4 việc bắt buộc theo đúng thứ tự: ①lập kế hoạch quản lý vệ sinh②lập sổ tay hướng dẫn (手引書の作成)③ghi chép và lưu trữ④kiểm chứng định kỳ.",
    sourceQuoteJa: "① 衛生管理計画の作成② 手引書の作成③ 記録と保存：衛生管理の実施状況を記録し、保存する。④ 定期的な検証",
    sourcePage: 5,
  },
  {
    id: "fb-hy4-1",
    chapterId: "hy-ch4",
    sentenceJa: "内壁・床の清掃（毎日）床から１m の高さまでの内壁は＿＿＿清掃します。",
    sentenceVi: "Phần tường nội thất tính từ sàn lên đến 1m cần được dọn dẹp với tần suất nào?",
    options: ["1年に1回", "1か月に1回", "毎日", "汚れたら考える"],
    correctIndex: 2,
    explanationVi: "Nội thất tính từ sàn lên 1m (gần bàn bếp, thức ăn thừa dễ bắn vào) cần được dọn dẹp MỖI NGÀY (毎日).",
    sourceQuoteJa: "内壁・床の清掃（毎日）床から１m の高さまでの内壁は毎日清掃します。",
    sourcePage: 7,
  },
  {
    id: "fb-hy4-2",
    chapterId: "hy-ch4",
    sentenceJa: "冷蔵庫内は＿＿＿℃以下、冷凍庫は－１５℃以下に保ちますが、微生物が死滅するわけではなく低温でも生存しています",
    sentenceVi: "Tiêu chuẩn nhiệt độ trong tủ lạnh là dưới bao nhiêu °C (tủ đông dưới -15°C)?",
    options: ["０", "５", "１０", "２５"],
    correctIndex: 2,
    explanationVi: "冷蔵庫内は10℃以下、冷凍庫は-15℃以下 — nhưng vi sinh vật vẫn có thể tồn tại ở nhiệt độ thấp nên vẫn cần dọn dẹp định kỳ.",
    sourceQuoteJa: "冷蔵庫内は１０℃以下、冷凍庫は－１５℃以下に保ちますが、微生物が死滅するわけではなく低温でも生存しています",
    sourcePage: 8,
  },
  {
    id: "fb-hy4-3",
    chapterId: "hy-ch4",
    sentenceJa: "特に＿＿＿はたまった油分に埃が付着し、その埃に火がついて火災の原因にもなります。",
    sentenceVi: "Bộ phận nào của máy hút mùi bếp, nếu tích tụ dầu và bụi, dễ bắt lửa gây hỏa hoạn?",
    options: ["排気ファン", "グリスフィルター", "電源コード", "外装カバー"],
    correctIndex: 1,
    explanationVi: "グリスフィルター (bộ lọc mỡ) tích bụi lẫn dầu rất dễ bắt lửa, trở thành nguyên nhân hỏa hoạn nếu không dọn dẹp.",
    sourceQuoteJa: "掃除を怠ると気化した油がレンジフード内で固化して清掃が困難になります。特にグリスフィルターはたまった油分に埃が付着し、その埃に火がついて火災の原因にもなります。",
    sourcePage: 8,
  },
  {
    id: "fb-hy4-4",
    chapterId: "hy-ch4",
    sentenceJa: "都道府県知事などがおこなう講習会または都道府県知事などが認める講習会（＿＿＿）を定期的に受講し、食品衛生に関する新たな知見の習得に努めること",
    sentenceVi: "Người phụ trách vệ sinh thực phẩm cần định kỳ tham gia loại khóa học nào để cập nhật kiến thức mới?",
    options: ["新入社員研修", "実務講習会", "経営者セミナー", "語学講座"],
    correctIndex: 1,
    explanationVi: "Người phụ trách vệ sinh thực phẩm phải định kỳ tham gia khóa học thực hành (実務講習会) để cập nhật kiến thức mới.",
    sourceQuoteJa: "都道府県知事などがおこなう講習会または都道府県知事などが認める講習会（実務講習会）を定期的に受講し、食品衛生に関する新たな知見の習得に努めること",
    sourcePage: 7,
  },
  {
    id: "fb-hy4-5",
    chapterId: "hy-ch4",
    sentenceJa: "排水溝は＿＿＿、適切に排水されるように清掃します。",
    sentenceVi: "Việc dọn dẹp rãnh thoát nước nhằm ngăn điều gì, để đảm bảo thoát nước đúng cách?",
    options: ["虫の卵の孵化を防ぎ", "固形物の流入を防ぎ", "騒音の発生を防ぎ", "水温の上昇を防ぎ"],
    correctIndex: 1,
    explanationVi: "排水溝 cần được dọn dẹp để NGĂN vật rắn (固形物) lọt vào, đảm bảo thoát nước đúng cách.",
    sourceQuoteJa: "排水溝の清掃（毎日）排水溝は固形物の流入を防ぎ、適切に排水されるように清掃します。",
    sourcePage: 7,
  },
  {
    id: "fb-hy5-1",
    chapterId: "hy-ch5",
    sentenceJa: "肉・魚：１０℃以下（生食用魚介類：＿＿＿℃以下）、生鮮果実・野菜：１０℃前後。",
    sentenceVi: "Riêng hải sản ăn sống, tiêu chuẩn nhiệt độ bảo quản sau sơ chế nghiêm ngặt hơn thịt/cá thường — là dưới bao nhiêu °C?",
    options: ["２", "４", "６", "８"],
    correctIndex: 1,
    explanationVi: "Hải sản ăn sống (生食用魚介類) cần bảo quản dưới 4°C — nghiêm ngặt hơn mức 10°C áp dụng cho thịt/cá thường.",
    sourceQuoteJa: "肉・魚：１０℃以下（生食用魚介類：４℃以下）、生鮮果実・野菜：１０℃前後。",
    sourcePage: 31,
  },
  {
    id: "fb-hy5-2",
    chapterId: "hy-ch5",
    sentenceJa: "凍結した肉や魚の解凍中に細菌の増殖を抑えるために、低温で解凍すると、＿＿＿も抑えられます。",
    sentenceVi: "Ngoài ức chế vi khuẩn sinh sôi, rã đông ở nhiệt độ thấp còn giúp hạn chế hiện tượng gì?",
    options: ["解凍時間の短縮", "食材の重量増加", "ドリップの発生", "色の変化"],
    correctIndex: 2,
    explanationVi: "Rã đông ở nhiệt độ thấp giúp ức chế vi khuẩn sinh sôi, đồng thời hạn chế hiện tượng rỉ dịch (ドリップの発生) từ thực phẩm.",
    sourceQuoteJa: "凍結した肉や魚の解凍中に細菌の増殖を抑えるために、低温で解凍すると、ドリップの発生も抑えられます。",
    sourcePage: 31,
  },
  {
    id: "fb-hy5-3",
    chapterId: "hy-ch5",
    sentenceJa: "ボツリヌス菌、ウエルシュ菌、セレウス菌などの食中毒菌は、熱に強い芽胞を形成するため、加熱調理時に＿＿＿℃で加熱しても死滅しませんので、加熱調理後の食品であっても芽胞の増殖抑制のための温度管理が重要です。",
    sentenceVi: "Vi khuẩn tạo bào tử chịu nhiệt cao, dù nấu ở mức nhiệt độ nào cũng không bị tiêu diệt hoàn toàn?",
    options: ["６０", "８０", "１００", "１２０"],
    correctIndex: 2,
    explanationVi: "Vi khuẩn tạo bào tử (như Clostridium botulinum) chịu nhiệt rất cao — dù nấu ở 100°C vẫn KHÔNG bị tiêu diệt hoàn toàn.",
    sourceQuoteJa: "ボツリヌス菌、ウエルシュ菌、セレウス菌などの食中毒菌は、熱に強い芽胞を形成するため、加熱調理時に１００℃で加熱しても死滅しませんので、加熱調理後の食品であっても芽胞の増殖抑制のための温度管理が重要です。",
    sourcePage: 32,
  },
  {
    id: "fb-hy5-4",
    chapterId: "hy-ch5",
    sentenceJa: "加熱調理後に冷却する食品は、細菌の増殖が可能な危険温度帯（＿＿＿℃）に置かれる時間を極力短くすることが重要です。",
    sentenceVi: "Vùng nhiệt độ nguy hiểm (thuận lợi cho vi khuẩn sinh sôi) mà thực phẩm sau khi nấu cần tránh ở lâu là khoảng nào?",
    options: ["０～５", "１０～６０", "７０～９０", "１００～１２０"],
    correctIndex: 1,
    explanationVi: "危険温度帯 (vùng nhiệt độ nguy hiểm) là 10-60°C — thực phẩm sau khi nấu cần được làm nguội nhanh để giảm thiểu thời gian ở trong vùng này.",
    sourceQuoteJa: "加熱調理後に冷却する食品は、細菌の増殖が可能な危険温度帯（１０～６０℃）に置かれる時間を極力短くすることが重要です。",
    sourcePage: 32,
  },
  {
    id: "fb-hy5-5",
    chapterId: "hy-ch5",
    sentenceJa: "自然・室温解凍：＿＿＿ことになるため、衛生管理上おこなってはいけない解凍方法です。",
    sentenceVi: "Rã đông ở nhiệt độ phòng bị cấm vì tạo cơ hội cho điều gì xảy ra?",
    options: ["電気代が上がる", "食材の表面で細菌が増殖する機会を与える", "調理時間が延びる", "食材の色が変わる"],
    correctIndex: 1,
    explanationVi: "Rã đông ở nhiệt độ phòng tạo cơ hội cho vi khuẩn sinh sôi trên bề mặt thực phẩm (食材の表面で細菌が増殖する機会を与える), nên bị cấm.",
    sourceQuoteJa: "自然・室温解凍：食材の表面で細菌が増殖する機会を与えることになるため、衛生管理上おこなってはいけない解凍方法です。",
    sourcePage: 32,
  },
  {
    id: "fb-ck1-1",
    chapterId: "ck-ch1",
    sentenceJa: "肉は死後硬直がゆるやかで、＿＿＿を経て、食べごろになるまで数日かかります。",
    sentenceVi: "Thịt sau khi giết mổ phải trải qua những giai đoạn nào (theo thứ tự) mới đạt độ ngon?",
    options: ["硬直、熟成、軟化", "熟成、硬直、軟化", "軟化、硬直、熟成", "硬直、軟化、熟成"],
    correctIndex: 0,
    explanationVi: "Thịt sau khi giết mổ trải qua CỨNG XÁC (硬直) → Ủ CHÍN (熟成) → MỀM HÓA (軟化) theo đúng thứ tự này, mất vài ngày mới đạt độ ngon.",
    sourceQuoteJa: "肉は死後硬直がゆるやかで、硬直、熟成、軟化を経て、食べごろになるまで数日かかります。",
    sourcePage: 1,
  },
  {
    id: "fb-ck1-2",
    chapterId: "ck-ch1",
    sentenceJa: "すね肉のような筋の多いものは、長時間加熱すると、タンパク質の一種である＿＿＿が分解されて柔らかくなります。",
    sentenceVi: "Khi làm nóng lâu phần thịt nhiều gân, loại protein nào bị phân giải khiến thịt trở nên mềm?",
    options: ["ケラチン", "コラーゲン", "アルブミン", "ミオシン"],
    correctIndex: 1,
    explanationVi: "Phần nhiều gân (như bắp chân), khi gia nhiệt lâu, collagen (コラーゲン — 1 loại protein) bị phân giải và thịt trở nên mềm.",
    sourceQuoteJa: "すね肉のような筋の多いものは、長時間加熱すると、タンパク質の一種であるコラーゲンが分解されて柔らかくなります。",
    sourcePage: 1,
  },
  {
    id: "fb-ck1-3",
    chapterId: "ck-ch1",
    sentenceJa: "結着肉などの成形肉は、細菌性食中毒を防止するために＿＿＿。",
    sentenceVi: "Với thịt kết dính/định hình, cần làm gì để phòng ngừa ngộ độc thực phẩm do vi khuẩn?",
    options: ["表面だけ火を通します", "冷凍のまま提供します", "肉の内部までしっかり火を通します", "強火のみで短時間調理します"],
    correctIndex: 2,
    explanationVi: "Thịt kết dính/định hình có thể có vi khuẩn lẫn vào bên trong khi chế biến, nên phải làm chín kỹ đến tận bên trong (肉の内部までしっかり火を通します).",
    sourceQuoteJa: "結着肉などの成形肉は、細菌性食中毒を防止するために肉の内部までしっかり火を通します。",
    sourcePage: 1,
  },
  {
    id: "fb-ck1-4",
    chapterId: "ck-ch1",
    sentenceJa: "以上のほか、すべての肉類に共通した鮮度の見分け方は以下のとおりです。・いやなにおいがしない。・ドリップ（液汁）が出ていない。・弾力がある。・＿＿＿。",
    sentenceVi: "Ngoài 3 điểm trên (không mùi khó chịu, không rỉ dịch, có độ đàn hồi), điểm chung thứ 4 để nhận biết thịt tươi cho mọi loại thịt là gì?",
    options: ["色が真っ白である", "ぬるぬるしていない", "重量が軽い", "透明である"],
    correctIndex: 1,
    explanationVi: "4 điểm chung cho mọi loại thịt: không mùi khó chịu, không rỉ dịch, có độ đàn hồi, KHÔNG NHỚT (ぬるぬるしていない).",
    sourceQuoteJa: "以上のほか、すべての肉類に共通した鮮度の見分け方は以下のとおりです。・いやなにおいがしない。・ドリップ（液汁）が出ていない。・弾力がある。・ぬるぬるしていない。",
    sourcePage: 2,
  },
  {
    id: "fb-ck1-5",
    chapterId: "ck-ch1",
    sentenceJa: "冷凍した食肉を使用するときは、下処理用の容器に移し、食肉・魚介類などの保管区分の冷蔵庫内で＿＿＿。",
    sentenceVi: "Thịt đông lạnh nên được rã đông như thế nào (chuyển sang hộp sơ chế, trong ngăn tủ lạnh dành cho thịt/hải sản)?",
    options: ["急速解凍する", "常温解凍する", "解凍せず調理する", "緩慢解凍する"],
    correctIndex: 3,
    explanationVi: "Thịt đông lạnh cần được chuyển sang hộp sơ chế và RÃ ĐÔNG CHẬM (緩慢解凍する) trong ngăn tủ lạnh dành riêng cho thịt/hải sản.",
    sourceQuoteJa: "冷凍した食肉を使用するときは、下処理用の容器に移し、食肉・魚介類などの保管区分の冷蔵庫内で緩慢解凍する。※解凍する際、ドリップが下に落ちるなどしてほかの食材や容器を汚染しないよう、トレイで受けるなどの工夫をすること。",
    sourcePage: 2,
  },
  {
    id: "fb-ck2-1",
    chapterId: "ck-ch2",
    sentenceJa: "調理の前にあらかじめ食材におこなう加工処理です。洗浄、あくをぬく、切れ目を入れる、＿＿＿などがあります。",
    sentenceVi: "Ngoài rửa/khử đắng/khía dao, sơ chế còn bao gồm công đoạn xử lý nào nữa (mục thứ 4 trong danh sách)?",
    options: ["乾物をもどす", "食材を廃棄する", "食材を仕入れる", "料理を盛り付ける"],
    correctIndex: 0,
    explanationVi: "Sơ chế (下処理) gồm: rửa, khử vị đắng/chát, khía dao, và NGÂM NỞ ĐỒ KHÔ (乾物をもどす).",
    sourceQuoteJa: "調理の前にあらかじめ食材におこなう加工処理です。洗浄、あくをぬく、切れ目を入れる、乾物をもどすなどがあります。",
    sourcePage: 5,
  },
  {
    id: "fb-ck2-2",
    chapterId: "ck-ch2",
    sentenceJa: "それら微生物を下処理中に増やさないことと、手指や調理器具・作業台を介して、加熱調理済み食品や殺菌済みの食品に汚染（＿＿＿）させないことが重要になります。",
    sentenceVi: "Khi sơ chế, cần tránh không để vi sinh vật sinh sôi, và tránh gây ra hiện tượng gì sang thực phẩm đã nấu chín/khử trùng?",
    options: ["一次汚染", "二次汚染", "自然汚染", "外部汚染"],
    correctIndex: 1,
    explanationVi: "Cần tránh làm vi sinh vật sinh sôi trong lúc sơ chế, và tránh gây ô nhiễm chéo (二次汚染) sang thực phẩm đã nấu chín/đã khử trùng qua tay, dụng cụ, mặt bàn.",
    sourceQuoteJa: "それら微生物を下処理中に増やさないことと、手指や調理器具・作業台を介して、加熱調理済み食品や殺菌済みの食品に汚染（二次汚染）させないことが重要になります。",
    sourcePage: 5,
  },
  {
    id: "fb-ck2-3",
    chapterId: "ck-ch2",
    sentenceJa: "汚れのすくないものから１枚ずつ水につけて洗います。最後に＿＿＿で洗います。",
    sentenceVi: "Sau khi ngâm rau từng lá trong nước (từ loại ít bẩn hơn), bước cuối cùng khi rửa rau là gì?",
    options: ["洗剤", "熱湯", "流水", "アルコール消毒液"],
    correctIndex: 2,
    explanationVi: "Rửa rau: bắt đầu từ loại ít bẩn hơn, ngâm nước từng lá một, cuối cùng rửa lại bằng NƯỚC CHẢY (流水).",
    sourceQuoteJa: "汚れのすくないものから１枚ずつ水につけて洗います。最後に流水で洗います。",
    sourcePage: 5,
  },
  {
    id: "fb-ck2-4",
    chapterId: "ck-ch2",
    sentenceJa: "葉物は＿＿＿ようにして葉が傷つかないように丁寧に洗います。",
    sentenceVi: "Khi rửa rau lá để không làm rách lá, cần thao tác thế nào?",
    options: ["しっかり縛る", "根元を広げる", "1枚ずつちぎる", "水に浸けない"],
    correctIndex: 1,
    explanationVi: "Rau lá: rửa cẩn thận bằng cách BANH RỘNG PHẦN GỐC (根元を広げる) để không làm rách lá.",
    sourceQuoteJa: "葉物は根元を広げるようにして葉が傷つかないように丁寧に洗います。",
    sourcePage: 5,
  },
  {
    id: "fb-ck2-5",
    chapterId: "ck-ch2",
    sentenceJa: "泥のついたものは、＿＿＿でよく洗って泥を落とし、最後に流水で洗います。",
    sentenceVi: "Rau còn dính đất nên dùng dụng cụ nào để cọ sạch đất trước khi rửa lại bằng nước chảy?",
    options: ["スポンジ", "たわし", "ふきん", "紙タオル"],
    correctIndex: 1,
    explanationVi: "Rau còn dính đất: dùng BÀN CHẢI (たわし) cọ kỹ để rửa sạch đất, cuối cùng rửa lại bằng nước chảy.",
    sourceQuoteJa: "泥のついたものは、たわしでよく洗って泥を落とし、最後に流水で洗います。",
    sourcePage: 5,
  },
  {
    id: "fb-ck3-1",
    chapterId: "ck-ch3",
    sentenceJa: "調理とは、食材に手を加え、衛生的で安全なものにする、味や香り、＿＿＿をよくして美味しいものにすることです。",
    sentenceVi: "Ngoài vệ sinh/an toàn/vị/hương thơm, nấu ăn còn cải thiện yếu tố nào để món ăn ngon miệng hơn?",
    options: ["色", "口触り", "価格", "盛り付け量"],
    correctIndex: 1,
    explanationVi: "Nấu ăn cải thiện vị, hương thơm, và CẢM GIÁC KHI ĂN (口触り) để món ăn ngon miệng hơn.",
    sourceQuoteJa: "調理とは、食材に手を加え、衛生的で安全なものにする、味や香り、口触りをよくして美味しいものにすることです。",
    sourcePage: 6,
  },
  {
    id: "fb-ck3-2",
    chapterId: "ck-ch3",
    sentenceJa: "美味しい料理をタイミングよく提供するためには、調理の手順を考えて効率よく作業することが大切です。食材を無駄なく使用し、水やガスなどの＿＿＿の節約も考えながら調理計画をたて作業しましょう。",
    sentenceVi: "Ngoài dùng nguyên liệu không lãng phí, lập kế hoạch nấu còn cần tính đến việc tiết kiệm điều gì (nước, gas...)?",
    options: ["エネルギー", "人件費", "時間だけ", "食器"],
    correctIndex: 0,
    explanationVi: "Lập kế hoạch nấu cần tính đến tiết kiệm NĂNG LƯỢNG (エネルギー — nước, gas...), không lãng phí nguyên liệu.",
    sourceQuoteJa: "美味しい料理をタイミングよく提供するためには、調理の手順を考えて効率よく作業することが大切です。食材を無駄なく使用し、水やガスなどのエネルギーの節約も考えながら調理計画をたて作業しましょう。",
    sourcePage: 6,
  },
  {
    id: "fb-ck3-3",
    chapterId: "ck-ch3",
    sentenceJa: "茹でる、煮る、揚げる、焼く、炒めるなど熱を加えて、安全に美味しく食すことができる状態にしましょう。消化吸収をよくし、＿＿＿を高める効果もあります。",
    sentenceVi: "Ngoài cải thiện tiêu hóa hấp thụ, nấu chín bằng nhiệt còn có tác dụng nâng cao yếu tố nào?",
    options: ["栄養", "重量", "価格", "保存期間のみ"],
    correctIndex: 0,
    explanationVi: "Nấu chín bằng nhiệt giúp cải thiện tiêu hóa hấp thụ và nâng cao giá trị DINH DƯỠNG (栄養).",
    sourceQuoteJa: "茹でる、煮る、揚げる、焼く、炒めるなど熱を加えて、安全に美味しく食すことができる状態にしましょう。消化吸収をよくし、栄養を高める効果もあります。",
    sourcePage: 6,
  },
  {
    id: "fb-ck3-4",
    chapterId: "ck-ch3",
    sentenceJa: "揚げ物を揚げ続けると油が酸化され、色や香りが悪くなり＿＿＿が増してきます。そのため、油の表面には持続性の泡立ちが起こるようになります。",
    sentenceVi: "Khi dầu chiên bị oxy hóa do dùng lại nhiều lần, ngoài màu/mùi kém đi, đặc tính vật lý nào của dầu cũng tăng lên?",
    options: ["粘り", "透明度", "重量", "香ばしさ"],
    correctIndex: 0,
    explanationVi: "Dầu chiên dùng lại nhiều lần bị oxy hóa: màu/mùi kém đi, ĐỘ NHỚT (粘り) tăng lên, mặt dầu xuất hiện bọt khí bền.",
    sourceQuoteJa: "揚げ物を揚げ続けると油が酸化され、色や香りが悪くなり粘りが増してきます。そのため、油の表面には持続性の泡立ちが起こるようになります。",
    sourcePage: 6,
  },
  {
    id: "fb-ck3-5",
    chapterId: "ck-ch3",
    sentenceJa: "炒める：高温・少量の油脂を用いて、撹拌しながら短時間で加熱します。複数の食材を入れるとき、＿＿＿具材から先に入れて熱の入り具合を均等にします。",
    sentenceVi: "Khi xào nhiều loại nguyên liệu cùng lúc, nên cho loại nào vào trước để nhiệt vào đều?",
    options: ["熱の通りが早い", "香りが強い", "熱の通りが遅い", "水分が多い"],
    correctIndex: 2,
    explanationVi: "Khi xào nhiều nguyên liệu, cho loại CHÍN CHẬM (熱の通りが遅い) vào trước để nhiệt vào đều tất cả nguyên liệu.",
    sourceQuoteJa: "炒める：高温・少量の油脂を用いて、撹拌しながら短時間で加熱します。複数の食材を入れるとき、熱の通りが遅い具材から先に入れて熱の入り具合を均等にします。",
    sourcePage: 6,
  },
  {
    id: "fb-ck4-1",
    chapterId: "ck-ch4",
    sentenceJa: "自動温度調節機能がついているものは、設定温度と実際の温度が一致しているか＿＿＿で確認してください。",
    sentenceVi: "Với thiết bị có chức năng tự động điều chỉnh nhiệt độ, dùng dụng cụ gì để kiểm tra nhiệt độ cài đặt và thực tế có khớp không?",
    options: ["非接触温度計", "接触温度計", "目視のみ", "手で触れる感覚のみ"],
    correctIndex: 0,
    explanationVi: "Phải dùng NHIỆT KẾ KHÔNG TIẾP XÚC (非接触温度計) để kiểm tra nhiệt độ cài đặt và thực tế có khớp nhau không.",
    sourceQuoteJa: "自動温度調節機能がついているものは、設定温度と実際の温度が一致しているか非接触温度計で確認してください。",
    sourcePage: 8,
  },
  {
    id: "fb-ck4-2",
    chapterId: "ck-ch4",
    sentenceJa: "換気が不十分だと＿＿＿を起こす恐れがあり、最悪の場合、死亡事故に至ることがあります。",
    sentenceVi: "Nếu thông gió không đủ khi dùng bếp gas, có nguy cơ ngộ độc loại khí nào?",
    options: ["酸素中毒", "一酸化炭素中毒", "二酸化炭素過多", "窒素中毒"],
    correctIndex: 1,
    explanationVi: "Thông gió không đủ có nguy cơ NGỘ ĐỘC KHÍ CO (一酸化炭素中毒), trường hợp xấu nhất có thể dẫn đến tử vong.",
    sourceQuoteJa: "換気が不十分だと一酸化炭素中毒を起こす恐れがあり、最悪の場合、死亡事故に至ることがあります。",
    sourcePage: 8,
  },
  {
    id: "fb-ck4-3",
    chapterId: "ck-ch4",
    sentenceJa: "庫内の温度を下げ、＿＿＿から掃除をおこなってください。",
    sentenceVi: "Trước khi dọn dẹp lò Combi Oven, ngoài hạ nhiệt độ bên trong, cần làm gì với nguồn điện?",
    options: ["電源を入れたまま", "電源を切って", "電源を最大にして", "電源を確認せず"],
    correctIndex: 1,
    explanationVi: "Phải hạ nhiệt độ bên trong lò và TẮT NGUỒN (電源を切って) trước khi dọn dẹp.",
    sourceQuoteJa: "庫内の温度を下げ、電源を切ってから掃除をおこなってください。",
    sourcePage: 8,
  },
  {
    id: "fb-ck4-4",
    chapterId: "ck-ch4",
    sentenceJa: "フライヤーの油の酸化値（AV 値＿＿＿未満）が正常か確認してください。",
    sentenceVi: "Chỉ số oxy hóa dầu chiên (AV) dưới bao nhiêu thì được coi là bình thường?",
    options: ["１．０", "２．０", "３．０", "５．０"],
    correctIndex: 2,
    explanationVi: "AV value dưới 3.0 là bình thường; từ 3.0 trở lên phải thay dầu vào cuối ca làm việc ngày đó.",
    sourceQuoteJa: "フライヤーの油の酸化値（AV 値３．０未満）が正常か確認してください。AV 値３．０以上であれば、その日の営業終了時に油を交換してください。",
    sourcePage: 8,
  },
  {
    id: "fb-ck4-5",
    chapterId: "ck-ch4",
    sentenceJa: "加熱調理直後の庫内には高温の水蒸気が充満しており、急にとびらを開けることで、手や顔に＿＿＿をすることのないように注意が必要です。",
    sentenceVi: "Mở cửa lò Combi Oven đột ngột ngay sau khi nấu chín có nguy cơ gây ra điều gì cho tay/mặt?",
    options: ["かゆみ", "しびれ", "かぶれ", "やけど"],
    correctIndex: 3,
    explanationVi: "Ngay sau khi nấu chín, bên trong lò đầy hơi nước nóng — mở cửa đột ngột có nguy cơ gây BỎNG (やけど) cho tay/mặt.",
    sourceQuoteJa: "加熱調理直後の庫内には高温の水蒸気が充満しており、急にとびらを開けることで、手や顔にやけどをすることのないように注意が必要です。",
    sourcePage: 8,
  },
  {
    id: "fb-ck5-1",
    chapterId: "ck-ch5",
    sentenceJa: "飲食店での労働災害で最も多い事故は「転倒」で全体の約＿＿＿を占めています。",
    sentenceVi: "Tai nạn 'té ngã' tại nhà hàng chiếm khoảng bao nhiêu % tổng số tai nạn lao động?",
    options: ["１割", "２割", "３割", "５割"],
    correctIndex: 2,
    explanationVi: "Tai nạn 'té ngã' là phổ biến nhất, chiếm khoảng 30% (３割) tổng số tai nạn lao động tại nhà hàng.",
    sourceQuoteJa: "飲食店での労働災害で最も多い事故は「転倒」で全体の約３割を占めています。",
    sourcePage: 11,
  },
  {
    id: "fb-ck5-2",
    chapterId: "ck-ch5",
    sentenceJa: "飲食店における労働災害は「転倒」、「切れ・こすれ」が多くを占めていますが、法令上の義務付けがないことから、＿＿＿現状があります。",
    sentenceVi: "Vì không có quy định pháp luật bắt buộc, thực tế hiện nay về biện pháp an toàn tại nhà hàng như thế nào?",
    options: ["安全面からの取組は十分におこなわれていない", "安全面の取組は完璧である", "安全対策は業界標準で統一されている", "保険で全て補償されるので対策不要である"],
    correctIndex: 0,
    explanationVi: "Vì không có quy định pháp luật bắt buộc, thực tế các biện pháp an toàn tại nhà hàng CHƯA được thực hiện đầy đủ (安全面からの取組は十分におこなわれていない).",
    sourceQuoteJa: "飲食店における労働災害は「転倒」、「切れ・こすれ」が多くを占めていますが、法令上の義務付けがないことから、安全面からの取組は十分におこなわれていない現状があります。",
    sourcePage: 11,
  },
  {
    id: "fb-ck5-3",
    chapterId: "ck-ch5",
    sentenceJa: "職場に潜む危険などは、＿＿＿ものが多くあります。それらを可視化（見える化）することで、より効果的な安全活動をおこなうことができます。",
    sentenceVi: "Nguy hiểm tiềm ẩn tại nơi làm việc có đặc điểm gì khiến cần trực quan hóa để nhận biết?",
    options: ["費用がかからない", "視覚的にとらえられない", "従業員が知っている", "毎日変化する"],
    correctIndex: 1,
    explanationVi: "Nhiều nguy hiểm tiềm ẩn tại nơi làm việc KHÔNG THỂ NHẬN BIẾT BẰNG MẮT THƯỜNG (視覚的にとらえられない), nên cần trực quan hóa.",
    sourceQuoteJa: "職場に潜む危険などは、視覚的にとらえられないものが多くあります。それらを可視化（見える化）することで、より効果的な安全活動をおこなうことができます。",
    sourcePage: 11,
  },
  {
    id: "fb-ck5-4",
    chapterId: "ck-ch5",
    sentenceJa: "飲食店に特徴的な状況として、＿＿＿が多く、その被災が目立っています。",
    sentenceVi: "Đặc trưng của nhà hàng là có nhiều lao động thuộc nhóm nào, và nhóm này bị tai nạn nhiều nổi bật?",
    options: ["高齢層の労働者", "若年層の労働者", "経営者層", "外国人管理職"],
    correctIndex: 1,
    explanationVi: "Đặc trưng của nhà hàng là có nhiều LAO ĐỘNG TRẺ TUỔI (若年層の労働者), và tỷ lệ họ bị tai nạn lao động nổi bật hơn.",
    sourceQuoteJa: "飲食店に特徴的な状況として、若年層の労働者が多く、その被災が目立っています。",
    sourcePage: 11,
  },
  {
    id: "fb-ck5-5",
    chapterId: "ck-ch5",
    sentenceJa: "このような労働災害を防止するため、飲食店においても、＿＿＿を決め、防止に向けた取り組みをおこなうなど、労働災害の防止に努めましょう。",
    sentenceVi: "Để phòng ngừa tai nạn lao động, nhà hàng nên chỉ định ai để thực hiện các biện pháp phòng ngừa?",
    options: ["経理担当者", "労働安全の担当者", "仕入れ担当者", "広報担当者"],
    correctIndex: 1,
    explanationVi: "Để phòng ngừa tai nạn lao động, nhà hàng nên chỉ định NGƯỜI PHỤ TRÁCH AN TOÀN LAO ĐỘNG (労働安全の担当者) và thực hiện các biện pháp phòng ngừa.",
    sourceQuoteJa: "このような労働災害を防止するため、飲食店においても、労働安全の担当者を決め、防止に向けた取り組みをおこなうなど、労働災害の防止に努めましょう。",
    sourcePage: 11,
  },
  {
    id: "fb-ck6-1",
    chapterId: "ck-ch6",
    sentenceJa: "食品が生産者から消費者に届くまでの経路は＿＿＿といい、生産者から農協などの出荷事業者、卸売市場や食品製造業、食品小売業などを経由して消費者の元に届きます。",
    sentenceVi: "Con đường thực phẩm đi từ nhà sản xuất đến người tiêu dùng được gọi là gì?",
    options: ["流通", "加工", "販売", "貿易"],
    correctIndex: 0,
    explanationVi: "Con đường thực phẩm đi từ nhà sản xuất đến người tiêu dùng gọi là LƯU THÔNG (流通).",
    sourceQuoteJa: "食品が生産者から消費者に届くまでの経路は流通といい、生産者から農協などの出荷事業者、卸売市場や食品製造業、食品小売業などを経由して消費者の元に届きます。",
    sourcePage: 15,
  },
  {
    id: "fb-ck6-2",
    chapterId: "ck-ch6",
    sentenceJa: "流通経路の中でも卸売市場は、①集荷、②価格形成、③決済、④情報受発信、⑤災害時対応、⑥＿＿＿機能を持ち、生鮮食料品などを安定的に供給するシステムとして運営されています。",
    sentenceVi: "Ngoài 5 chức năng trên, chợ đầu mối còn có chức năng thứ 6 nào?",
    options: ["広告宣伝", "衛生の保持", "従業員教育", "税務申告"],
    correctIndex: 1,
    explanationVi: "6 chức năng của chợ đầu mối: thu gom hàng, hình thành giá, thanh toán, tiếp nhận/phát tin, ứng phó thiên tai, và GIỮ VỆ SINH (衛生の保持).",
    sourceQuoteJa: "流通経路の中でも卸売市場は、①集荷、②価格形成、③決済、④情報受発信、⑤災害時対応、⑥衛生の保持機能を持ち、生鮮食料品などを安定的に供給するシステムとして運営されています。",
    sourcePage: 15,
  },
  {
    id: "fb-ck6-3",
    chapterId: "ck-ch6",
    sentenceJa: "飲食店で食材の仕入れをする際、①小売店（近隣商店・スーパー）、②業務用専門スーパー、③卸売市場、④＿＿＿など、さまざまな仕入先があります。",
    sentenceVi: "Ngoài 3 nguồn nhập hàng trên, nguồn nhập hàng thứ 4 là gì?",
    options: ["個人フリーマーケット", "生産者直売所のみ", "卸売業者（通信販売も含む）", "海外輸入業者のみ"],
    correctIndex: 2,
    explanationVi: "4 nguồn nhập nguyên liệu: cửa hàng bán lẻ, siêu thị chuyên bán sỉ cho kinh doanh, chợ đầu mối, và NHÀ CUNG CẤP SỈ (卸売業者 — bao gồm cả bán hàng qua thư/online).",
    sourceQuoteJa: "飲食店で食材の仕入れをする際、①小売店（近隣商店・スーパー）、②業務用専門スーパー、③卸売市場、④卸売業者（通信販売も含む）など、さまざまな仕入先があります。",
    sourcePage: 15,
  },
  {
    id: "fb-ck6-4",
    chapterId: "ck-ch6",
    sentenceJa: "生鮮食料品などを＿＿＿システムとして運営されています。",
    sentenceVi: "Chợ đầu mối được vận hành như hệ thống có chức năng gì đối với thực phẩm tươi sống?",
    options: ["安定的に供給する", "不定期に販売する", "価格を統一する", "品質を検査するだけの"],
    correctIndex: 0,
    explanationVi: "Chợ đầu mối được vận hành như một hệ thống CUNG CẤP ỔN ĐỊNH (安定的に供給する) các thực phẩm tươi sống.",
    sourceQuoteJa: "生鮮食料品などを安定的に供給するシステムとして運営されています。",
    sourcePage: 15,
  },
  {
    id: "fb-ck6-5",
    chapterId: "ck-ch6",
    sentenceJa: "お店のコンセプトや各仕入先のメリット・デメリットを見極め、＿＿＿ことが重要です。",
    sentenceVi: "Sau khi cân nhắc concept cửa hàng và ưu nhược điểm từng nguồn nhập hàng, điều quan trọng cần làm là gì?",
    options: ["価格が最も安いところを選ぶ", "1つの仕入先に固定する", "仕入先の数を減らす", "自店にあった仕入先を選択する"],
    correctIndex: 3,
    explanationVi: "Điều quan trọng là CHỌN NGUỒN NHẬP HÀNG PHÙ HỢP VỚI CỬA HÀNG MÌNH (自店にあった仕入先を選択する), không chỉ dựa vào giá rẻ nhất.",
    sourceQuoteJa: "お店のコンセプトや各仕入先のメリット・デメリットを見極め、自店にあった仕入先を選択することが重要です。",
    sourcePage: 15,
  },
  {
    id: "fb-ck7-1",
    chapterId: "ck-ch7",
    sentenceJa: "食品の製造過程において、＿＿＿の目的で食品に添加されるものを食品添加物といいます。",
    sentenceVi: "Phụ gia thực phẩm được thêm vào với mục đích gì trong quá trình sản xuất?",
    options: ["着色や増量", "加工や保存", "廃棄や輸送", "包装や陳列"],
    correctIndex: 1,
    explanationVi: "Phụ gia thực phẩm (食品添加物) là chất được thêm vào với mục đích CHẾ BIẾN hoặc BẢO QUẢN (加工や保存).",
    sourceQuoteJa: "食品の製造過程において、加工や保存の目的で食品に添加されるものを食品添加物といいます。",
    sourcePage: 16,
  },
  {
    id: "fb-ck7-2",
    chapterId: "ck-ch7",
    sentenceJa: "食品安全基本法に基づき設置された＿＿＿は動物試験などの結果をもとに食品添加物を評価し、安全性を確認したものについて、厚生労働大臣が指定する「指定添加物」として、食品ごとに基準値を設定しています。",
    sentenceVi: "Cơ quan nào được thành lập theo Luật cơ bản về An toàn Thực phẩm, đánh giá phụ gia dựa trên thử nghiệm động vật?",
    options: ["食品安全委員会", "消費者庁", "厚生労働省本庁", "農林水産省"],
    correctIndex: 0,
    explanationVi: "Ủy ban An toàn Thực phẩm (食品安全委員会) được thành lập theo Luật cơ bản về An toàn Thực phẩm, đánh giá phụ gia thực phẩm dựa trên kết quả thử nghiệm động vật.",
    sourceQuoteJa: "食品安全基本法に基づき設置された食品安全委員会は動物試験などの結果をもとに食品添加物を評価し、安全性を確認したものについて、厚生労働大臣が指定する「指定添加物」として、食品ごとに基準値を設定しています。",
    sourcePage: 16,
  },
  {
    id: "fb-ck7-3",
    chapterId: "ck-ch7",
    sentenceJa: "安全性を確認したものについて、＿＿＿が指定する「指定添加物」として、食品ごとに基準値を設定しています。",
    sentenceVi: "Ai là người có thẩm quyền chỉ định 'phụ gia được chỉ định' sau khi đã xác nhận an toàn?",
    options: ["厚生労働大臣", "都道府県知事", "食品安全委員会自身", "消費者庁長官"],
    correctIndex: 0,
    explanationVi: "Sau khi Ủy ban An toàn Thực phẩm xác nhận an toàn, chính BỘ TRƯỞNG Y TẾ LAO ĐỘNG PHÚC LỢI (厚生労働大臣) là người chỉ định 'phụ gia được chỉ định'.",
    sourceQuoteJa: "安全性を確認したものについて、厚生労働大臣が指定する「指定添加物」として、食品ごとに基準値を設定しています。",
    sourcePage: 16,
  },
  {
    id: "fb-ck7-4",
    chapterId: "ck-ch7",
    sentenceJa: "そのほか、食品添加物には、長年使用されてきた天然添加物として品目が決められている「＿＿＿」、一般の食品を添加物の目的で使用した「一般飲食物添加物」、「天然香料」の４つの種類があります。",
    sentenceVi: "Loại phụ gia truyền thống, đã dùng lâu năm và được quy định sẵn danh mục, gọi là gì?",
    options: ["指定添加物", "既存添加物", "輸入添加物", "臨時添加物"],
    correctIndex: 1,
    explanationVi: "4 loại phụ gia gồm: chỉ định (指定添加物), TRUYỀN THỐNG/HIỆN CÓ (既存添加物), từ thực phẩm thông thường (一般飲食物添加物), hương liệu tự nhiên (天然香料).",
    sourceQuoteJa: "そのほか、食品添加物には、長年使用されてきた天然添加物として品目が決められている「既存添加物」、一般の食品を添加物の目的で使用した「一般飲食物添加物」、「天然香料」の４つの種類があります。",
    sourcePage: 16,
  },
  {
    id: "fb-ck7-5",
    chapterId: "ck-ch7",
    sentenceJa: "酸化防止剤 油脂などの酸化を防ぎ保存性をよくする ＿＿＿、ミックスビタミンＥ",
    sentenceVi: "Ngoài vitamin E hỗn hợp, ví dụ khác của chất chống oxy hóa dùng trong thực phẩm là gì?",
    options: ["クエン酸", "エリソルビン酸ナトリウム", "亜硝酸ナトリウム", "安息香酸ナトリウム"],
    correctIndex: 1,
    explanationVi: "Ví dụ chất chống oxy hóa (酸化防止剤): natri erythorbate (エリソルビン酸ナトリウム), vitamin E hỗn hợp.",
    sourceQuoteJa: "酸化防止剤 油脂などの酸化を防ぎ保存性をよくする エリソルビン酸ナトリウム、ミックスビタミンＥ",
    sourcePage: 17,
  },
  {
    id: "fb-cs1-1",
    chapterId: "cs-ch1",
    sentenceJa: "日本における接客サービスの特性として、「＿＿＿」（＝ホスピタリティ）があります。",
    sentenceVi: "Đặc trưng của dịch vụ tiếp khách tại Nhật Bản, tương đương với 'hospitality', được gọi bằng từ tiếng Nhật nào?",
    options: ["おもてなし", "がんばり", "しつけ", "がまん"],
    correctIndex: 0,
    explanationVi: "Đặc trưng dịch vụ tiếp khách tại Nhật Bản là 'OMOTENASHI' (おもてなし = hospitality, lòng hiếu khách).",
    sourceQuoteJa: "日本における接客サービスの特性として、「おもてなし」（＝ホスピタリティ）があります。",
    sourcePage: 1,
  },
  {
    id: "fb-cs1-2",
    chapterId: "cs-ch1",
    sentenceJa: "この期待を＿＿＿、十分に満足して帰り、リピーターとして再来店する確率は増加します。",
    sentenceVi: "Nếu kỳ vọng của khách được xử lý thế nào thì khả năng khách hài lòng và quay lại tăng lên?",
    options: ["変えなければ", "下回れば", "上回れば", "無視すれば"],
    correctIndex: 2,
    explanationVi: "Nếu VƯỢT kỳ vọng (上回れば) của khách, khả năng khách hài lòng và quay lại làm khách quen tăng lên.",
    sourceQuoteJa: "この期待を上回れば、十分に満足して帰り、リピーターとして再来店する確率は増加します。逆に期待を下回れば不満を感じて再来店はなく、場合によっては友人や知人にそのクレームを伝えます。クレームに関する情報は広がりやすく、潜在的なお客様まで減少させてしまいます。",
    sourcePage: 1,
  },
  {
    id: "fb-cs1-3",
    chapterId: "cs-ch1",
    sentenceJa: "客席内における動作の基本は、＿＿＿の３つです。",
    sentenceVi: "3 nguyên tắc cơ bản về hành động trong khu vực bàn khách là gì?",
    options: ["ゆっくり・静かに・丁寧に", "ニコニコ、ハキハキ、キビキビ", "速く・大声で・力強く", "控えめに・無言で・ゆったりと"],
    correctIndex: 1,
    explanationVi: "3 nguyên tắc cơ bản: Nico-nico (cười tươi), Haki-haki (nói rõ ràng), Kibi-kibi (nhanh nhẹn).",
    sourceQuoteJa: "客席内における動作の基本は、ニコニコ、ハキハキ、キビキビの３つです。",
    sourcePage: 2,
  },
  {
    id: "fb-cs1-4",
    chapterId: "cs-ch1",
    sentenceJa: "従業員へのあいさつが重要な一番目の理由は、「今日は気持ちよく、＿＿＿で仕事をしたいので、よろしくお願いします」との意思表示をし、相手も「こちらこそよろしくお願いします」、心で握手を交わしている状態にするためです。",
    sentenceVi: "Câu chào đầu ca giữa các nhân viên thể hiện mong muốn gì với nhau trong công việc hôm đó?",
    options: ["競争心", "個人主義", "上下関係", "心を合わせ、チームワーク"],
    correctIndex: 3,
    explanationVi: "Chào hỏi giữa nhân viên thể hiện ý muốn ĐỒNG LÒNG, LÀM VIỆC THEO TINH THẦN ĐỒNG ĐỘI (心を合わせ、チームワーク).",
    sourceQuoteJa: "従業員へのあいさつが重要な一番目の理由は、「今日は気持ちよく、心を合わせ、チームワークで仕事をしたいので、よろしくお願いします」との意思表示をし、相手も「こちらこそよろしくお願いします」、心で握手を交わしている状態にするためです。",
    sourcePage: 3,
  },
  {
    id: "fb-cs1-5",
    chapterId: "cs-ch1",
    sentenceJa: "飲食店においてお客様に評価・満足してもらうため、店舗責任者（店長など）や時間帯責任者は、料理の内容、サービスの内容、清潔感の問題、手違い、クレーム対応などの＿＿＿として行動することが求められます。",
    sentenceVi: "Người phụ trách cửa hàng/khung giờ được yêu cầu đóng vai trò gì, chịu trách nhiệm toàn diện về món ăn/dịch vụ/vệ sinh/sai sót/khiếu nại?",
    options: ["厨房作業員", "接客全般の責任者", "経理担当者", "広告担当者"],
    correctIndex: 1,
    explanationVi: "Người phụ trách cửa hàng/khung giờ phải đóng vai trò NGƯỜI CHỊU TRÁCH NHIỆM TOÀN DIỆN VỀ TIẾP KHÁCH (接客全般の責任者).",
    sourceQuoteJa: "飲食店においてお客様に評価・満足してもらうため、店舗責任者（店長など）や時間帯責任者は、料理の内容、サービスの内容、清潔感の問題、手違い、クレーム対応などの接客全般の責任者として行動することが求められます。",
    sourcePage: 1,
  },
  {
    id: "fb-cs2-1",
    chapterId: "cs-ch2",
    sentenceJa: "食物アレルギーのお客様が知らずに該当する食材を食べて発症すると、最悪の場合、＿＿＿を起こして呼吸困難になり死亡することもあります。",
    sentenceVi: "Trường hợp xấu nhất khi khách dị ứng ăn phải thực phẩm gây dị ứng mà không biết, phản ứng nào có thể xảy ra dẫn đến khó thở/tử vong?",
    options: ["アナフィラキシーショック", "一時的な発疹", "軽い頭痛", "味覚異常"],
    correctIndex: 0,
    explanationVi: "Trường hợp xấu nhất có thể bị SỐC PHẢN VỆ (アナフィラキシーショック) dẫn đến khó thở và tử vong.",
    sourceQuoteJa: "食物アレルギーのお客様が知らずに該当する食材を食べて発症すると、最悪の場合、アナフィラキシーショックを起こして呼吸困難になり死亡することもあります。",
    sourcePage: 8,
  },
  {
    id: "fb-cs2-2",
    chapterId: "cs-ch2",
    sentenceJa: "情報提供した内容が誤っていたり、最新の情報でなかったりしたことで、事故になった場合は、＿＿＿となることがありますので、十分に注意する必要があります。",
    sentenceVi: "Nếu thông tin dị ứng cung cấp sai/lỗi thời dẫn đến sự cố, có thể phát sinh vấn đề gì?",
    options: ["責任問題", "税務問題", "在庫問題", "広告問題"],
    correctIndex: 0,
    explanationVi: "Thông tin sai/lỗi thời dẫn đến sự cố có thể phát sinh VẤN ĐỀ TRÁCH NHIỆM (責任問題).",
    sourceQuoteJa: "情報提供した内容が誤っていたり、最新の情報でなかったりしたことで、事故になった場合は、責任問題となることがありますので、十分に注意する必要があります。",
    sourcePage: 8,
  },
  {
    id: "fb-cs2-3",
    chapterId: "cs-ch2",
    sentenceJa: "そばとうどんを同じ釜でゆでている店舗では、＿＿＿か確認してください。",
    sentenceVi: "Quán luộc mì soba và udon chung 1 nồi cần xác nhận điều gì đã được thực hiện?",
    options: ["そのことをお客様に伝えている", "うどんの提供をやめている", "そばの提供をやめている", "特に何もしていない"],
    correctIndex: 0,
    explanationVi: "Quán luộc soba/udon chung nồi phải THÔNG BÁO ĐIỀU ĐÓ CHO KHÁCH (そのことをお客様に伝えている) — nguy cơ nhiễm chéo với người dị ứng kiều mạch.",
    sourceQuoteJa: "そばとうどんを同じ釜でゆでている店舗では、そのことをお客様に伝えているか確認してください。",
    sourcePage: 9,
  },
  {
    id: "fb-cs2-4",
    chapterId: "cs-ch2",
    sentenceJa: "特に、＿＿＿（イスラム圏での原材料基準）ではアルコールは使えないため、食材にアルコールをかけることはできませんので注意してください。",
    sentenceVi: "Tiêu chuẩn nguyên liệu theo đạo Hồi, cấm dùng cồn kể cả rưới lên thực phẩm, được gọi là gì?",
    options: ["ヴィーガン", "ハラール", "コーシャ", "オーガニック"],
    correctIndex: 1,
    explanationVi: "HALAL (ハラール — tiêu chuẩn nguyên liệu theo đạo Hồi) không cho phép dùng cồn dưới bất kỳ hình thức nào.",
    sourceQuoteJa: "特に、ハラール（イスラム圏での原材料基準）ではアルコールは使えないため、食材にアルコールをかけることはできませんので注意してください。",
    sourcePage: 10,
  },
  {
    id: "fb-cs2-5",
    chapterId: "cs-ch2",
    sentenceJa: "ムスリムやベジタリアンなどのお客様が来店したときは、できるだけそのお客様が＿＿＿料理を提供することが望まれます。",
    sentenceVi: "Khi khách theo đạo Hồi/ăn chay đến quán, nên làm gì trước khi phục vụ món ăn?",
    options: ["好きなものを追加して", "食べられないものを除いて確認を取ってから", "全メニューをそのまま", "値段を割引してから"],
    correctIndex: 1,
    explanationVi: "Nên LOẠI BỎ NHỮNG THỨ KHÁCH KHÔNG ĂN ĐƯỢC, XÁC NHẬN RỒI MỚI PHỤC VỤ (食べられないものを除いて確認を取ってから).",
    sourceQuoteJa: "ムスリムやベジタリアンなどのお客様が来店したときは、できるだけそのお客様が食べられないものを除いて確認を取ってから料理を提供することが望まれます。",
    sourcePage: 10,
  },
  {
    id: "fb-cs3-1",
    chapterId: "cs-ch3",
    sentenceJa: "客席については、開店準備は最初に＿＿＿か確認してください。店内の温度を上げたり下げたりするには時間がかかるので、開店時に最適にするために必要です。",
    sentenceVi: "Việc đầu tiên cần làm khi chuẩn bị mở cửa cho khu vực bàn khách là kiểm tra gì (vì điều chỉnh nhiệt độ cần thời gian)?",
    options: ["空調機の電源を入れている", "BGMをかけている", "テーブルを拭いている", "従業員の点呼をとっている"],
    correctIndex: 0,
    explanationVi: "Việc đầu tiên cần làm là BẬT NGUỒN MÁY ĐIỀU HÒA (空調機の電源を入れている), vì điều chỉnh nhiệt độ trong quán cần thời gian.",
    sourceQuoteJa: "客席については、開店準備は最初に空調機の電源を入れているか確認してください。店内の温度を上げたり下げたりするには時間がかかるので、開店時に最適にするために必要です。",
    sourcePage: 10,
  },
  {
    id: "fb-cs3-2",
    chapterId: "cs-ch3",
    sentenceJa: "調理設備については、フライヤー、グリドル、湯煎などはスイッチを入れたり、点火したりしてから使用できるようになるまでに時間がかかるので、＿＿＿にスイッチを入れたり点火したりしているか確認してください。",
    sentenceVi: "Thiết bị bếp như chảo chiên, bàn nướng, bồn ủ nhiệt nên được bật công tắc vào thời điểm nào?",
    options: ["開店直後", "閉店直前", "開店３０分前", "営業中いつでも"],
    correctIndex: 2,
    explanationVi: "Các thiết bị bếp cần thời gian sau khi bật mới dùng được, nên phải bật từ TRƯỚC KHI MỞ CỬA 30 PHÚT (開店30分前).",
    sourceQuoteJa: "調理設備については、フライヤー、グリドル、湯煎などはスイッチを入れたり、点火したりしてから使用できるようになるまでに時間がかかるので、開店３０分前にスイッチを入れたり点火したりしているか確認してください。",
    sourcePage: 11,
  },
  {
    id: "fb-cs3-3",
    chapterId: "cs-ch3",
    sentenceJa: "清掃の教育訓練は、一番最初に＿＿＿指導しなければなりません。ほかの従業員に任せると、間違った覚え方をすることがあります。",
    sentenceVi: "Ai nên là người đầu tiên hướng dẫn đào tạo dọn dẹp vệ sinh, để tránh nhân viên học sai cách?",
    options: ["新人従業員", "外部の清掃業者", "アルバイトのリーダー", "店舗責任者みずから"],
    correctIndex: 3,
    explanationVi: "Đào tạo dọn dẹp phải do CHÍNH NGƯỜI PHỤ TRÁCH CỬA HÀNG (店舗責任者みずから) hướng dẫn đầu tiên.",
    sourceQuoteJa: "清掃の教育訓練は、一番最初に店舗責任者みずから指導しなければなりません。ほかの従業員に任せると、間違った覚え方をすることがあります。",
    sourcePage: 13,
  },
  {
    id: "fb-cs3-4",
    chapterId: "cs-ch3",
    sentenceJa: "閉店後レジ締めをおこない、所定のバッグに現金と入金票を入れて投入します。この時必ず＿＿＿でおこなってください。理由は防犯のためです。",
    sentenceVi: "Vì lý do phòng chống trộm cắp, nộp tiền vào két đêm bắt buộc phải có bao nhiêu người thực hiện?",
    options: ["一人", "二人", "三人以上", "警備員1人"],
    correctIndex: 1,
    explanationVi: "Nộp tiền vào két đêm bắt buộc phải có HAI NGƯỜI (二人) thực hiện vì lý do phòng chống trộm cắp.",
    sourceQuoteJa: "閉店後レジ締めをおこない、所定のバッグに現金と入金票を入れて投入します。この時必ず二人でおこなってください。理由は防犯のためです。",
    sourcePage: 16,
  },
  {
    id: "fb-cs3-5",
    chapterId: "cs-ch3",
    sentenceJa: "ただし、翌日用の釣銭は＿＿＿に保管してください。",
    sentenceVi: "Tiền lẻ dùng cho ngày hôm sau nên được cất giữ ở đâu?",
    options: ["夜間金庫", "店内金庫", "従業員の個人ロッカー", "レジの引き出し"],
    correctIndex: 1,
    explanationVi: "Tiền lẻ dùng cho ngày hôm sau phải cất trong KÉT SẮT TRONG CỬA HÀNG (店内金庫), không phải két đêm (dành cho doanh thu).",
    sourceQuoteJa: "ただし、翌日用の釣銭は店内金庫に保管してください。",
    sourcePage: 16,
  },
  {
    id: "fb-cs4-1",
    chapterId: "cs-ch4",
    sentenceJa: "クレームはなるべく受けたくないと考えるのが普通ですが、一方クレームは店の＿＿＿につながる大きな材料でもあります。",
    sentenceVi: "Dù không ai muốn nhận khiếu nại, nhưng khiếu nại cũng là tư liệu quan trọng để làm gì cho cửa hàng?",
    options: ["宣伝広告", "質的改善", "売上拡大のみ", "人員削減"],
    correctIndex: 1,
    explanationVi: "Khiếu nại là tư liệu quan trọng để CẢI THIỆN CHẤT LƯỢNG (質的改善) cửa hàng, dù ai cũng không muốn nhận.",
    sourceQuoteJa: "クレームはなるべく受けたくないと考えるのが普通ですが、一方クレームは店の質的改善につながる大きな材料でもあります。ですからその材料をもらえる機会となれば、対応する態度も変わってくるはずです。",
    sourcePage: 16,
  },
  {
    id: "fb-cs4-2",
    chapterId: "cs-ch4",
    sentenceJa: "どんな小さな苦情でも部下から報告させ、＿＿＿が迅速に直接テーブルまで行き対応します。",
    sentenceVi: "Dù khiếu nại nhỏ đến đâu, sau khi nhân viên cấp dưới báo cáo, ai cần nhanh chóng đến tận bàn xử lý trực tiếp?",
    options: ["店長", "アルバイト", "本部の担当者", "警備員"],
    correctIndex: 0,
    explanationVi: "Dù khiếu nại nhỏ, CỬA HÀNG TRƯỞNG (店長) phải nhanh chóng đến tận bàn xử lý trực tiếp sau khi nhân viên cấp dưới báo cáo.",
    sourceQuoteJa: "どんな小さな苦情でも部下から報告させ、店長が迅速に直接テーブルまで行き対応します。",
    sourcePage: 16,
  },
  {
    id: "fb-cs4-3",
    chapterId: "cs-ch4",
    sentenceJa: "クレームの大半は異物混入で、とりわけ多いのが＿＿＿の混入です。",
    sentenceVi: "Phần lớn khiếu nại là do dị vật lẫn trong món ăn, đặc biệt phổ biến nhất là loại dị vật nào?",
    options: ["昆虫", "髪の毛", "プラスチック片", "金属片"],
    correctIndex: 1,
    explanationVi: "Phần lớn khiếu nại do dị vật lẫn trong món ăn, đặc biệt phổ biến nhất là TÓC (髪の毛).",
    sourceQuoteJa: "クレームの大半は異物混入で、とりわけ多いのが髪の毛の混入です。",
    sourcePage: 18,
  },
  {
    id: "fb-cs4-4",
    chapterId: "cs-ch4",
    sentenceJa: "＿＿＿を調べ、再発しないよう従業員の身だしなみを確認してください。",
    sentenceVi: "Khi phát hiện tóc lẫn trong món ăn, ngoài kiểm tra tác phong nhân viên, cần điều tra thêm điều gì?",
    options: ["いつ発見したか", "どこで混入したか", "誰が最初に見たか", "料金はいくらか"],
    correctIndex: 1,
    explanationVi: "Phải điều tra NƠI TÓC LẪN VÀO (どこで混入した) và kiểm tra tác phong nhân viên để tránh tái diễn.",
    sourceQuoteJa: "どこで混入したかを調べ、再発しないよう従業員の身だしなみを確認してください。",
    sourcePage: 18,
  },
  {
    id: "fb-cs4-5",
    chapterId: "cs-ch4",
    sentenceJa: "髪の毛の次に多いのが＿＿＿の混入です。そのために捕虫器をつけている場合、捕虫器のランプが切れていないか確認してください。",
    sentenceVi: "Sau tóc, nguyên nhân dị vật phổ biến thứ hai là gì (liên quan đến đèn bẫy côn trùng)?",
    options: ["虫", "プラスチック", "紙くず", "ガラス片"],
    correctIndex: 0,
    explanationVi: "Sau tóc, nguyên nhân phổ biến thứ hai là CÔN TRÙNG (虫) lẫn vào; cần kiểm tra bóng đèn bẫy côn trùng.",
    sourceQuoteJa: "髪の毛の次に多いのが虫の混入です。そのために捕虫器をつけている場合、捕虫器のランプが切れていないか確認してください。",
    sourcePage: 18,
  },
  {
    id: "fb-cs5-1",
    chapterId: "cs-ch5",
    sentenceJa: "お客様で体調不良者が発生した場合、決して＿＿＿、同伴者がいれば同伴者の指示に従ってください。",
    sentenceVi: "Khi có khách bị khó chịu trong người, thái độ của nhân viên tuyệt đối không được như thế nào?",
    options: ["慌てずに", "笑わずに", "無視せずに", "遅れずに"],
    correctIndex: 0,
    explanationVi: "Khi có khách bị khó chịu, tuyệt đối KHÔNG ĐƯỢC HOẢNG LOẠN (慌てずに), nếu có người đi cùng thì làm theo chỉ dẫn người đó.",
    sourceQuoteJa: "お客様で体調不良者が発生した場合、決して慌てずに、同伴者がいれば同伴者の指示に従ってください。",
    sourcePage: 18,
  },
  {
    id: "fb-cs5-2",
    chapterId: "cs-ch5",
    sentenceJa: "同伴者がいない場合、意識がある場合はご本人の意思に従い、意識はない場合はすぐに＿＿＿を呼んでください。",
    sentenceVi: "Nếu khách bất tỉnh và không có người đi cùng, cần gọi ngay đơn vị nào?",
    options: ["家族", "救急車", "警察", "保健所"],
    correctIndex: 1,
    explanationVi: "Nếu không có người đi cùng và khách BẤT TỈNH, phải gọi XE CẤP CỨU (救急車) ngay.",
    sourceQuoteJa: "同伴者がいない場合、意識がある場合はご本人の意思に従い、意識はない場合はすぐに救急車を呼んでください。",
    sourcePage: 18,
  },
  {
    id: "fb-cs5-3",
    chapterId: "cs-ch5",
    sentenceJa: "＿＿＿抱き起こさず、そのままの状態で待機してください。",
    sentenceVi: "Với khách bị khó chịu, không nên bế khách dậy theo cách nào?",
    options: ["ゆっくりと", "丁寧に", "むやみに", "静かに"],
    correctIndex: 2,
    explanationVi: "KHÔNG ĐƯỢC TÙY TIỆN (むやみに) bế khách dậy, phải giữ nguyên tư thế và chờ đợi.",
    sourceQuoteJa: "むやみに抱き起こさず、そのままの状態で待機してください。",
    sourcePage: 18,
  },
  {
    id: "fb-cs5-4",
    chapterId: "cs-ch5",
    sentenceJa: "心停止を起こしたお客様には、＿＿＿をすぐに当ててください。そして同時に救急車を呼んでください。",
    sentenceVi: "Với khách bị ngừng tim, cần dùng thiết bị nào ngay lập tức (đồng thời gọi cấp cứu)?",
    options: ["体温計", "AED（自動体外式除細動器）", "血圧計", "聴診器"],
    correctIndex: 1,
    explanationVi: "Với khách ngừng tim, phải dùng MÁY AED (自動体外式除細動器) ngay lập tức, đồng thời gọi xe cấp cứu.",
    sourceQuoteJa: "心停止を起こしたお客様には、AED（自動体外式除細動器）をすぐに当ててください。そして同時に救急車を呼んでください。",
    sourcePage: 19,
  },
  {
    id: "fb-cs5-5",
    chapterId: "cs-ch5",
    sentenceJa: "AED（自動体外式除細動器）の使い方の訓練を＿＿＿実施してください。",
    sentenceVi: "Việc đào tạo cách sử dụng AED cần được thực hiện với tần suất nào?",
    options: ["1度だけ", "店長のみ", "緊急時のみ", "定期的に"],
    correctIndex: 3,
    explanationVi: "Phải thực hiện đào tạo ĐỊNH KỲ (定期的に) về cách sử dụng máy AED, không phải chỉ 1 lần.",
    sourceQuoteJa: "AED（自動体外式除細動器）の使い方の訓練を定期的に実施してください。",
    sourcePage: 19,
  },
  {
    id: "fb-sm1-5",
    chapterId: "sm-ch1",
    sentenceJa: "※上記のマネジメントとは、原価管理に関する発注・検品収納管理、水道光熱費などコスト管理、＿＿＿（カスタマリーリレーションやクレーム対応）、人件費に関する時間管理や不足要員の手配などです。",
    sentenceVi: "4 mảng quản lý của người phụ trách khung giờ gồm giá vốn, chi phí điện nước, mảng nào bao gồm xử lý khiếu nại, và giờ công nhân sự?",
    options: ["財務管理", "顧客管理", "広告管理", "販促管理"],
    correctIndex: 1,
    explanationVi: "4 mảng quản lý: giá vốn (発注・検品収納管理), chi phí điện nước, quan hệ khách hàng (顧客管理 — gồm cả xử lý khiếu nại), giờ công nhân sự.",
    sourceQuoteJa: "※上記のマネジメントとは、原価管理に関する発注・検品収納管理、水道光熱費などコスト管理、顧客管理（カスタマリーリレーションやクレーム対応）、人件費に関する時間管理や不足要員の手配などです。",
    sourcePage: 1,
  },
];
